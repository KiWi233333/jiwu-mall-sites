...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"极物圈是一个商城、社交平台，用户可以在这里钱包充值、查看、下单商品（虚拟），发布自己的帖子，评论别人的帖子。"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"}],"link":[{"rel":"icon","href":"/logo.png","sizes":"any"},{"rel":"apple-touch-icon","href":"/logo.png"}],"style":[],"script":[],"noscript":[],"title":"极物圈 - 开启你的购物社区之旅 ✨","viewport":"width=device-width,initial-scale=1"};
...
const getServerEntry = () => import('../app/server.mjs').then(function (n) { return n.g6; }).then((r) => r.default || r);
