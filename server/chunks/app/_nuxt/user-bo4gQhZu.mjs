...
import { k as useSettingStore, u as useUserStore, eT as _imports_0, A as useRoute, f as __nuxt_component_2$1, b as _export_sfc } from '../server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ClientOnly = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu fixed z-998 h-full bg-light bg-opacity-80 backdrop-blur-30 md:sticky md:block dark:bg-[#121212] md:shadow-none" }, _attrs))} data-v-468b6ece>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ClientOnly = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-100vh flex flex-col" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_MenuHeaderMenuSe, { class: "sticky left-0 top-0 z-1001 max-w-100vw" }, {
...
//# sourceMappingURL=user-bo4gQhZu.mjs.map
