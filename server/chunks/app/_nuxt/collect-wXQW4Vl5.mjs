import { b as _export_sfc, B as BaseUrlImg, u as useUserStore, a2 as useAsyncData, S as StatusCode, aG as delete_default, n as navigateTo, a5 as useHead, D as appName, g as ElMessageBox, E as ElMessage, h as ElButton, f as __nuxt_component_2$1, _ as __nuxt_component_0$1 } from '../server.mjs';
import { E as ElDivider } from './divider-SNINqp0P.mjs';
import { E as ElTabs, a as ElTabPane } from './tab-pane-G1YGUFAr.mjs';
import { E as ElCheckbox, a as ElCheckboxGroup, b as ElCheckboxButton } from './checkbox-grGLuZ3r.mjs';
...
import { a as getGoodsCollectList, t as toggleGoodsCollectStatus, d as deleteBatchGoodsCollectByIds } from './collect-lhYy0sJ5.mjs';
import { w as watchDebounced, t as toReactive } from './index-daJZwzbi.mjs';
import { _ as _sfc_main$6 } from './AutoIncre-nAzYjQ1D.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-qWvYy4Gj.mjs';
import { E as ElTag } from './index-Ve7Fq5RY.mjs';
import { _ as _sfc_main$5 } from './TagList-HC8gpUm-.mjs';
import { f as PostActionType, i as getCommPostActionPage, t as togglePostAction } from './post-VFNrEwmr.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "group w-full flex flex-col cursor-pointer border-transparent rounded-4px dark:border-transparent" }, _attrs))}><div class="img relative h-8rem w-full overflow-hidden rounded-t-inherit md:h-9rem">`);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ "overflow-x-hidden": "" }, _attrs, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isLoading), void 0, {
        fullscreen: true,
        lock: true
      })))} data-v-4734e6cb><div class="mb-3 flex-row-bt-c" data-v-4734e6cb><small opacity-60 data-v-4734e6cb>\u64CD \u4F5C \uFF1A</small><div class="btns flex" data-v-4734e6cb><div class="${ssrRenderClass([{ "w-14.8em": unref(isEdit) }, "w-0 flex justify-between overflow-hidden truncate opacity-80 transition-300 transition-width"])}" mr-2 data-v-4734e6cb>`);
      ...
      _push(ssrRenderComponent(_component_el_button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createTextVNode(toDisplayString(unref(isEdit) ? "\u53D6\u6D88" : "\u7BA1\u7406"), 1)
            ];
          }
        }),
        _: 1
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_checkbox_group, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${ssrRenderAttrs(mergeProps({ grid: "~ cols-2 md:cols-5 gap-6" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate, {
                    duration: 300,
                    ...
                    _push3(ssrRenderComponent(_component_el_checkbox_button, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [
                            createVNode(_component_UserCollectGoodsCard, {
                              data: p,
                              onLink: ($event) => !unref(isEdit) && ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))(`/goods/detail/${p.goods.id}`),
                              onCancel: cancelCollect
                            }, {
                  ...
                  return [
                    withDirectives((openBlock(), createBlock("div", { grid: "~ cols-2 md:cols-5 gap-6" }, [
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
            ...
            return [
              createVNode("div", { class: "flex-row-bt-c" }, [
                createVNode("h4", {
                  ...
                  createTextVNode(" " + toDisplayString((_h2 = (_g2 = _ctx.data) == null ? void 0 : _g2.postInfo) == null ? void 0 : _h2.title), 1)
                ])
              ])
            ];
          }
      ...
      _push(`<div class="mt-a flex-row-bt-c" data-v-530a5227><div class="mt-4 hidden w-full items-center gap-2 md:flex" data-v-530a5227><span class="tip-group tip-group link-text mr-2" data-v-530a5227><i class="i-solar:chat-dots-outline mr-1 p-0.5em" data-v-530a5227></i><small data-v-530a5227>${ssrInterpolate(((_b = (_a = _ctx.data) == null ? void 0 : _a.postInfo) == null ? void 0 : _b.comments) || "\u6682\u65E0")}</small></span><span class="link-text mr-2" data-v-530a5227><i class="i-solar:like-outline mr-1 p-0.5em" data-v-530a5227></i><small data-v-530a5227>${ssrInterpolate(((_d = (_c = _ctx.data) == null ? void 0 : _c.postInfo) == null ? void 0 : _d.likes) || "\u6682\u65E0")}</small></span><span${ssrRenderAttrs(mergeProps({ class: "link-text" }, ssrGetDirectiveProps(_ctx, _directive_copying, `${Host}/community/post/detail/${(_f = (_e = _ctx.data) == null ? void 0 : _e.postInfo) == null ? void 0 : _f.id}`, void 0, { toast: true })))} data-v-530a5227><i class="i-solar:share-outline mr-1 p-0.5em" data-v-530a5227></i><small data-v-530a5227>\u5206\u4EAB</small></span><span class="link-text" data-v-530a5227><i class="i-solar:star-outline mr-1 p-0.5em" data-v-530a5227></i><small data-v-530a5227>\u53D6\u6D88\u6536\u85CF</small></span></div>`);
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              return [
                createVNode(_component_CommTagList, {
                  size: "small",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    function onChancelCollect({ id, postId }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _directive_auto_animate = resolveDirective("auto-animate");
      _push(ssrRenderComponent(_component_el_scrollbar, mergeProps({ height: "70vh" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode(_component_ClientOnly, null, {
                default: withCtx(() => [
                  withDirectives((openBlock(), createBlock("div", { class: "grid grid-gap-6" }, [
                    createVNode(_component_ListAutoIncre, {
                      ...
                      onLoad: loadPostListPage
                        ...
                        withDirectives(createVNode("p", {
                          ...
                          "tracking-1": "",
                          "text-bluegray": ""
                        }, toDisplayString(unref(isNoMore) ? "\u6682\u65E0\u66F4\u591A\u5E16\u5B50" : "\u6682\u65E0\u5E16\u5B50"), 513), [
                          [vShow, unref(isNoMore) || unref(isNot)]
                        ])
                      ]),
                      default: withCtx(() => [
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(postList), (p) => {
                          return openBlock(), createBlock("div", {
                            key: p.id,
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<i class="i-solar:star-bold-duotone bg-yellow-4 p-0.5em" data-v-9478b72a${_scopeId}></i></h2><div style="${ssrRenderStyle(unref(user).isLogin ? null : { display: "none" })}" data-v-9478b72a${_scopeId}></div></div>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {}, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "layout-default" }, [
                createVNode("div", { class: "flex-row-bt-c" }, [
                  createVNode("h2", { class: "mb-8 mt-4 flex animate-[fade-in-down_0.4s] items-center" }, [
                    createTextVNode(" \u6211\u7684\u6536\u85CF "),
                    createVNode(_component_ElDivider, {
                      direction: "vertical",
                      style: { "margin": "0 1rem" }
                    }),
                    createVNode("i", { class: "i-solar:star-bold-duotone bg-yellow-4 p-0.5em" })
                  ]),
                  withDirectives(createVNode("div", null, null, 512), [
                    [vShow, unref(user).isLogin]
                  ])
                ]),
                createVNode(_component_ClientOnly, null, {
                  default: withCtx(() => [
                    createVNode("div", { class: "animate-[fade-in_.3s_ease] rounded-14px p-6 leading-1.4em shadow card-default" }, [
                      createVNode(_component_el_tabs, {
                        ...
                        default: withCtx(() => [
                          createVNode(_component_el_tab_pane, {
                            ...
                            default: withCtx(() => [
                              createVNode(_component_UserCollectGoodsList)
                            ]),
                            _: 1
                          }),
                          createVNode(_component_el_tab_pane, {
                            ...
                            default: withCtx(() => [
                              createVNode(_component_UserCollectPostActionList, {
                                dto: {
...
//# sourceMappingURL=collect-wXQW4Vl5.mjs.map
