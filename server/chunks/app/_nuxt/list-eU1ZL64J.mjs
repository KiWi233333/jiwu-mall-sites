import { b as _export_sfc, i as isTrue, B as BaseUrlImg, c as useSeoMeta, d as appKeywords, u as useUserStore, n as navigateTo, _ as __nuxt_component_0$1, f as __nuxt_component_2$1 } from '../server.mjs';
...
import __nuxt_component_2 from './PostList-Wuy5b0GJ.mjs';
import { _ as _sfc_main$4 } from './SigninCard-zf-9e3x9.mjs';
import __nuxt_component_6 from './Rank-l5ic3HVq.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => getPostPageLazy(1, 8, { viewsSort: isTrue.TRUE })), __temp = await __temp, __restore(), __temp);
      ...
      _push(ssrRenderComponent(_component_swiper, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_swiper_slide, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [
                            (p == null ? void 0 : p.cover) ? (openBlock(), createBlock("img", {
                              key: 0,
                              loading: "lazy",
                          ...
                          if (_push4) {
                            ...
                            return [
                              ...
                              createVNode("small", {
                                ...
                                createTextVNode(toDisplayString(p == null ? void 0 : p.user.nickname) + " ", 1),
                                createVNode("small", {
                                  "opacity-60": "",
                                  "transition-200": "",
                    ...
                    return [
                      createVNode("div", { class: "swiper-card relative overflow-hidden card-default" }, [
                        p.isEssence ? (openBlock(), createBlock("div", {
                          key: 0,
                          class: "is-essence shadow-sm"
                        }, " \u7CBE\u9009 ")) : createCommentVNode("", true),
                        ...
                        p.user ? (openBlock(), createBlock(_component_NuxtLink, {
                          key: 1,
                          to: `/user/info?id=${p == null ? void 0 : p.userId}`,
                          class: "absolute right-1rem top-1rem flex-row-bt-c cursor-pointer rounded bg-transparent px-3 py-2 leading-1.1em text-white backdrop-blur transition-300 group-hover:bg-[#31313142] hover:bg-[#33333333] hover:backdrop-blur dark:backdrop-blur-0"
                        }, {
                        ...
                        createVNode("div", {
                          ...
                          createVNode("h2", { class: "blur-card-line truncate px-4 py-2" }, toDisplayString(p.title), 1),
                          p.tags ? (openBlock(), createBlock("div", {
                            key: 0,
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList((_d = (_c = unref(data)) == null ? void 0 : _c.data) == null ? void 0 : _d.records, (p) => {
  ...
  setup(__props) {
    ...
    const menuList = [
      ...
      },
      {
        ...
        dto: { isEssence: isTrue.TRUE }
      },
      {
        name: "comment",
        icon: "i-solar:chat-round-line-bold-duotone mr-2 ",
        label: "\u70ED\u8BC4",
        dto: { commentSort: isTrue.TRUE }
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
              ...
              _push2(ssrRenderComponent(_component_el_tab_pane, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      createVNode(_component_CommPostList, {
                        dto: p.dto,
                        class: "grid grid-gap-4"
                      }, null, 8, ["dto"])
                    ];
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-3b07f61b>`);
      _push(ssrRenderComponent(_component_NuxtLayout, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div layout-default grid="~ cols-1 gap-6" data-v-3b07f61b${_scopeId}><h2 mt-2 leading-1.8em data-v-3b07f61b${_scopeId}> Hello, <br data-v-3b07f61b${_scopeId}>\u6B22\u8FCE\u6765\u5230\u6781\u7269\u5708 \u{1F451} </h2><div grid="~ md:cols-[5fr_2fr] cols-1 gap-6 items-start" min-h-100vh data-v-3b07f61b${_scopeId}><main class="pt-0" grid="~ cols-1 gap-6" data-v-3b07f61b${_scopeId}>`);
            _push2(ssrRenderComponent(_component_CommPostSwiper, { class: "h-20rem w-full" }, null, _parent2, _scopeId));
            ...
            _push2(`</main><section class="sticky top-5rem flex flex-col gap-6" data-v-3b07f61b${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_OtherPreLoading, {
            ...
            return [
              createVNode("div", {
                ...
                createVNode("h2", {
                  ...
                  createVNode("br"),
                  createTextVNode("\u6B22\u8FCE\u6765\u5230\u6781\u7269\u5708 \u{1F451} ")
                ]),
                createVNode("div", {
                  ...
                  createVNode("main", {
                    ...
                    createVNode(_component_CommPostSwiper, { class: "h-20rem w-full" }),
                    createVNode(_component_ClientOnly, null, {
                      ...
                      default: withCtx(() => [
                        createVNode(_component_CommPostTabs)
                      ]),
                      _: 1
                    })
                  ]),
                  createVNode("section", { class: "sticky top-5rem flex flex-col gap-6" }, [
                    createVNode(_component_ClientOnly, null, {
                      fallback: withCtx(() => [
                        createVNode(_component_OtherPreLoading, {
                          message: "",
                      ...
                      default: withCtx(() => [
                        unref(user).isLogin ? (openBlock(), createBlock(_component_UserInfoSigninCard, {
                          key: 0,
...
const list = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3b07f61b"]]);

export { list as default };
//# sourceMappingURL=list-eU1ZL64J.mjs.map
