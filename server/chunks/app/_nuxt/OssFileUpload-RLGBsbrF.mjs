import { q as buildProps, I as definePropType, J as mutable, K as full_screen_default, L as scale_to_original_default, r as useNamespace, t as isNumber, M as ElIcon, N as close_default, O as arrow_left_default, P as arrow_right_default, Q as zoom_out_default, R as zoom_in_default, T as refresh_left_default, U as refresh_right_default, w as withInstall, u as useUserStore, B as BaseUrlImg, b as _export_sfc, y as _export_sfc$1, S as StatusCode, V as plus_default } from '../server.mjs';
...
import { e as useEventListener } from './index-daJZwzbi.mjs';
import { throttle } from 'lodash-unified';
import { u as useLocale } from './index-RvHFA2kt.mjs';
import { u as useZIndex } from './focus-trap-r09CvUzW.mjs';
import { k as keysOf } from './objects-HNc5gIZI.mjs';
import { u as useAttrs$1 } from './index-nLRih88y.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    uploadQuality: { default: 0.6 },
    accept: { default: "image/*" },
    uploadType: { default: OssFileType.IMAGE },
    size: {},
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "input-list relative flex cursor-pointer select-none" }, _attrs, ssrGetDirectiveProps(_ctx, _directive_auto_animate)))} data-v-1146d693><div flex-row-c-c transition-300 hover:border="[var(--el-color-primary)]" class="${ssrRenderClass([_ctx.inputClass, "relative z-1 backdrop-blur-12px border-default-dashed hover:text-[var(--el-color-primary)]"])}" data-v-1146d693><input class="z-10 block h-full w-full cursor-pointer opacity-0 absolute-center" type="file"${ssrIncludeBooleanAttr(_ctx.multiple) ? " multiple" : ""}${ssrRenderAttr("accept", _ctx.accept)}${ssrIncludeBooleanAttr(_ctx.required) ? " required" : ""}${ssrIncludeBooleanAttr(_ctx.disable) ? " disabled" : ""}${ssrRenderAttr("draggable", _ctx.draggable)} data-v-1146d693>`);
      _push(ssrRenderComponent(_component_ElIconPlus, { class: "h-1/3 w-1/3 absolute-center" }, null, _parent));
      _push(`</div>`);
      if (_ctx.uploadType === unref(OssFileType).IMAGE) {
        _push(`<!--[-->`);
        ssrRenderList(unref(fileList), (p, index) => {
          _push(`<div class="${ssrRenderClass([unref(preImageClass), "pre-group flex flex-shrink-0 overflow-hidden backdrop-blur-12px"])}" data-v-1146d693>`);
          ...
          _push(`<div class="absolute left-0 top-0 h-full w-full flex-row-c-c" data-v-1146d693>`);
          if (p.status !== "success") {
            ...
            _push(`<div class="pre-group-hover absolute h-full w-full flex-row-c-c gap-1 opacity-0 backdrop-blur-12px transition-300" data-v-1146d693>`);
            ssrRenderSlot(_ctx.$slots, "pre-btns", {}, () => {
              _push(`<i class="pre-btn hover:bg-[var(--el-color-danger)]" i-solar:trash-bin-trash-bold-duotone data-v-1146d693></i>`);
              if ((p == null ? void 0 : p.percent) && (p == null ? void 0 : p.percent) < 100) {
                _push(`<div class="h-1/5 max-h-2rem max-w-2rem w-1/5 cursor-pointer hover:bg-[var(--el-color-danger)]" i-solar:close-circle-bold-duotone data-v-1146d693></div>`);
              } else {
                _push(`<!---->`);
              }
            }, _push, _parent);
      ...
      if (_ctx.uploadType === unref(OssFileType).VIDEO) {
        ...
        ssrRenderList(_ctx.modelValue, (p) => {
          _push(`<div class="${ssrRenderClass([unref(preImageClass), "pre-group relative flex-shrink-0 overflow-hidden backdrop-blur-12px"])}" data-v-1146d693><video${ssrRenderAttr("src", p.id)} controls z-0 h-full w-full select-none object-cover data-v-1146d693></video><div class="absolute left-0 top-0 z-1 h-1/4 w-full flex-row-c-c" data-v-1146d693>`);
          if ((p == null ? void 0 : p.percent) && (p == null ? void 0 : p.percent) < 100) {
            _push(ssrRenderComponent(_component_el_progress, {
          ...
          if (!(p == null ? void 0 : p.percent) && (p == null ? void 0 : p.percent) < 100) {
            _push(`<div class="z-2 h-1/5 max-h-2rem max-w-2rem w-1/5 cursor-pointer hover:bg-[var(--el-color-danger)]" i-solar:close-circle-bold data-v-1146d693></div>`);
          } else {
            _push(`<div class="pre-group-hover absolute left-0 top-0 h-full w-full flex-row-c-c gap-1 opacity-0 backdrop-blur-20px transition-300 v-card" data-v-1146d693>`);
            ssrRenderSlot(_ctx.$slots, "pre-btns", {}, () => {
              _push(`<div class="h-full max-h-2rem max-w-2rem w-1/5 cursor-pointer hover:bg-[var(--el-color-danger)]" i-solar:trash-bin-trash-bold-duotone data-v-1146d693></div>`);
            }, _push, _parent);
            _push(`</div>`);
          }
          _push(`</div></div>`);
      ...
      _push(`<div style="${ssrRenderStyle(unref(error) ? null : { display: "none" })}" class="${ssrRenderClass([_ctx.errorClass, "m-1 block w-full overflow-hidden truncate text-[var(--el-color-danger)] leading-1em opacity-80"])}" data-v-1146d693>${ssrInterpolate(unref(error))}</div></div>`);
    };
  }
});
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1146d693"]]);

export { __nuxt_component_9 as _ };
//# sourceMappingURL=OssFileUpload-RLGBsbrF.mjs.map
