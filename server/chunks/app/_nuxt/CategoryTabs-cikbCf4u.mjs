...
import __nuxt_component_2$1 from './PostList--cNB2Ocs.mjs';
import __nuxt_component_1 from './GoodsList-AABL3AGj.mjs';
          ...
          if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_el_tab_pane, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [p.lcomponent ? (openBlock(), createBlock(resolveDynamicComponent(p.lcomponent), {
                      key: 0,
                      dto: p.dto,
                      class: p.lClass || "grid grid-gap-6"
            ...
            return [(openBlock(), createBlock(Fragment, null, renderList(menuList, (p) => {
              return createVNode(_component_el_tab_pane, {
                ...
                default: withCtx(() => [p.lcomponent ? (openBlock(), createBlock(resolveDynamicComponent(p.lcomponent), {
                  key: 0,
                  dto: p.dto,
                  class: p.lClass || "grid grid-gap-6"
                }, null, 8, ["dto", "class"])) : createCommentVNode("", true)]),
...
//# sourceMappingURL=CategoryTabs-cikbCf4u.mjs.map
