import { b as _export_sfc, c as useSeoMeta, u as useUserStore, _ as __nuxt_component_0 } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      title: "\u5BA2\u670D\u804A\u5929 - \u6781\u7269\u5708 \u{1F451}",
      description: "\u5BA2\u670D\u804A\u5929 - \u6781\u7269\u5708 \u5F00\u542F\u4F60\u7684\u6781\u7269\u4E4B\u65C5\uFF01",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-236b698d>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/chat/service.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const service = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-236b698d"]]);

export { service as default };
//# sourceMappingURL=service-ZE9n4_cX.mjs.map
