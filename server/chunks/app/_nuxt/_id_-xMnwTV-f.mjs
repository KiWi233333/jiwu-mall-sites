import { h as buildProps, O as iconPropType, j as useNamespace, z as definePropType, F as ElIcon, w as withInstall, P as withNoopInstall, A as mutable, I as arrow_right_default, Q as buttonTypes, R as question_filled_default, T as addUnit, g as ElButton, b as _export_sfc, l as _export_sfc$1, B as BaseUrlImg, U as BaseUrlVideo, u as useUserStore, V as useShopStore, t as useRoute, S as StatusCode, c as useSeoMeta, k as isNumber, e as __nuxt_component_0$1, W as arrow_left_bold_default, X as arrow_right_bold_default, E as ElMessage, n as navigateTo, d as __nuxt_component_2$1, _ as __nuxt_component_0, o as BaseUrl } from '../server.mjs';
...
import { g as getGoodsCategoryByGid, _ as __nuxt_component_2$2 } from './GoodsListSsr-hXClBatk.mjs';
import { _ as _sfc_main$e } from './PreLoading-Sou-hyZj.mjs';
...
import { g as getGoodsIsCollect, t as toggleGoodsCollectStatus } from './collect-jWDvukS4.mjs';
import { E as ElRadioGroup, b as ElRadioButton, a as ElRadio } from './index-pIjkPV4Z.mjs';
...
import { a as getEventsGoodsSkuList } from './index-I9ZbP2md.mjs';
import currency from 'currency.js';
import { E as ElTabs, a as ElTabPane } from './tab-pane-VfJmI_8q.mjs';
import { ElText } from './index-eePIGq3N.mjs';
import { _ as _sfc_main$f } from './AutoIncre-z4AO2g2Q.mjs';
import { E as ElRate } from './rate-sgIhPeyv.mjs';
import { E as ElDialog } from './dialog-5eWjtfeR.mjs';
import { u as useAsyncData, a as useFetch } from './fetch-YS3Fxkuj.mjs';
import { isString, isArray } from '@vue/shared';
import { U as UPDATE_MODEL_EVENT, C as CHANGE_EVENT } from './event-9ZI5GX64.mjs';
import { castArray } from 'lodash-unified';
import { _ as _CollapseTransition } from './index-OUXJ-ySL.mjs';
import { g as generateId } from './rand-7lfgVUL1.mjs';
import { g as getGoodsInfoById, a as addGoodsViewsById } from './index-4eJaJKt8.mjs';
import { g as getGoodsSkuByGid } from './sku-V9DXfY1F.mjs';
...
var Breadcrumb = /* @__PURE__ */ _export_sfc$1(_sfc_main$d, [["__file", "breadcrumb.vue"]]);
...
var BreadcrumbItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["__file", "breadcrumb-item.vue"]]);
...
var Popconfirm = /* @__PURE__ */ _export_sfc$1(_sfc_main$9, [["__file", "popconfirm.vue"]]);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const {
      data
    } = ([__temp, __restore] = withAsyncContext(() => getGoodsCategoryByGid(gid.toString())), __temp = await __temp, __restore(), __temp);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [createVNode(_component_NuxtLink, {
                    ...
                    default: withCtx(() => [createTextVNode(" \u4E3B\u9875 ")]),
                    _: 1
                  })];
                }
              }),
            ...
            _push2(ssrRenderComponent(_component_el_breadcrumb_item, {
              style: ((_a22 = unref(category)) == null ? void 0 : _a22.id) ? null : {
                display: "none"
              }
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        return [createTextVNode(toDisplayString((_b3 = unref(category)) == null ? void 0 : _b3.name), 1)];
                      }
                    }),
                    _: 1
                  }, _parent3, _scopeId2));
                  ...
                  return [createVNode(_component_NuxtLink, {
                    ...
                    default: withCtx(() => {
                      var _a4;
                      return [createTextVNode(toDisplayString((_a4 = unref(category)) == null ? void 0 : _a4.name), 1)];
                    }),
                    _: 1
                  }, 8, ["to"])];
                }
            ...
            return [createVNode(_component_el_breadcrumb_item, null, {
              ...
              _: 1
            }, 512), [[vShow, (_b = unref(category)) == null ? void 0 : _b.id]]), withDirectives(createVNode(_component_el_breadcrumb_item, null, {
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "swiper w-full flex flex-col"
      }, _attrs))} data-v-1cc7c0fb>`);
      ...
      _push(ssrRenderComponent(_component_el_scrollbar, mergeProps({
        "view-class": "flex py-4 cursor-pointer"
      }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (_ctx.video) {
              _push2(`<div class="${ssrRenderClass([{
                active: unref(activeSmall) === _ctx.video
              }, "scale-img relative mx-1 block h-4rem max-w-8rem min-w-4rem flex flex-shrink-0 flex-shrink-0 shadow card-default"])}" data-v-1cc7c0fb${_scopeId}><i i-solar:alt-arrow-right-bold-duotone absolute left-0 top-0 h-full w-full p-0.6em data-v-1cc7c0fb${_scopeId}></i></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<!--[-->`);
            ssrRenderList(_ctx.images, (p, i) => {
              _push2(`<div class="${ssrRenderClass([{
                active: unref(activeSmall) === p
              }, "scale-img mx-1 block h-4rem max-w-8rem min-w-4rem flex flex-shrink-0 flex-shrink-0 shadow-sm card-default"])}" data-v-1cc7c0fb${_scopeId}>`);
            ...
            return [_ctx.video ? (openBlock(), createBlock("div", {
              key: _ctx.video,
              class: ["scale-img relative mx-1 block h-4rem max-w-8rem min-w-4rem flex flex-shrink-0 flex-shrink-0 shadow card-default", {
                active: unref(activeSmall) === _ctx.video
              }],
              ...
              "w-full": "",
              "p-0.6em": ""
            })], 42, ["onMouseenter"])) : createCommentVNode("", true), (openBlock(true), createBlock(Fragment, null, renderList(_ctx.images, (p, i) => {
              return openBlock(), createBlock("div", {
                key: i,
                class: ["scale-img mx-1 block h-4rem max-w-8rem min-w-4rem flex flex-shrink-0 flex-shrink-0 shadow-sm card-default", {
                  active: unref(activeSmall) === p
                }]
                ...
                "hover:scale-110": "",
                onMouseenter: ($event) => setActiveItem(p)
              }, null, 8, ["preview-src-list", "src", "alt", "onMouseenter"])], 2);
            }), 128))];
          }
        }),
        _: 1
  ...
  async setup(__props) {
    ...
    if (user.getTokenFn()) {
      if (props.gid) {
        const {
          data
        } = ([__temp, __restore] = withAsyncContext(() => getGoodsIsCollect(props.gid, user.getTokenFn())), __temp = await __temp, __restore(), __temp);
    ...
    async function onCollectGoods() {
      ...
      const {
        code,
        message
      } = await toggleGoodsCollectStatus(props.gid, user.getToken);
        ...
        reference: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(mergeProps({
              "cursor-pointer": ""
            }, ssrGetDirectiveProps(_ctx, _directive_auth)))}${_scopeId}><span class="${ssrRenderClass(unref(isCollect) ? "i-solar:stars-minimalistic-bold-duotone bg-yellow-5" : "i-solar:stars-minimalistic-broken")}" animate-zoom-in p-3 transition-200${_scopeId}></span></div>`);
          } else {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_el_tag, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  return [createTextVNode(toDisplayString(((_c3 = _ctx.goodsInfo) == null ? void 0 : _c3.postage) ? `${(_d3 = _ctx.goodsInfo) == null ? void 0 : _d3.postage}\u5143\u8FD0\u8D39` : "\u514D\u8FD0\u8D39"), 1)];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_el_tag, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  return [createTextVNode(toDisplayString(((_c3 = _ctx.goodsInfo) == null ? void 0 : _c3.refundTime) ? `${(_d3 = _ctx.goodsInfo) == null ? void 0 : _d3.refundTime}\u65E5\u65E0\u7406\u7531\u9000\u8D27` : ""), 1)];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_radio_group, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [(openBlock(true), createBlock(Fragment, null, renderList(unref(sizeList), (p) => {
                    ...
                    return [createVNode(_component_el_radio_group, {
                      ...
                      default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(unref(sizeList), (p) => {
                        return openBlock(), createBlock(_component_el_radio_button, {
                          key: p.name,
                          label: p.name
                        }, null, 8, ["label"]);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_radio_group, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [(openBlock(true), createBlock(Fragment, null, renderList(unref(colorList), (p) => {
                    ...
                    return [createVNode(_component_el_radio_group, {
                      ...
                      default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(unref(colorList), (p) => {
                        return openBlock(), createBlock(_component_el_radio, {
                          key: p.name,
                          border: true,
                          label: p.name,
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_el_radio_group, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          return [(openBlock(true), createBlock(Fragment, null, renderList(unref(comboList), (p) => {
                            return openBlock(), createBlock(_component_el_radio_button, {
                              key: p.name,
                              label: p.name
                            }, null, 8, ["label"]);
                    ...
                    return [createVNode(_component_el_radio_group, {
                      ...
                      default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(unref(comboList), (p) => {
                        return openBlock(), createBlock(_component_el_radio_button, {
                          key: p.name,
                          label: p.name
                        }, null, 8, ["label"]);
            ...
            _push2(ssrRenderComponent(_component_el_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<small style="${ssrRenderStyle(unref(isAllCheckSku) ? null : {
                    display: "none"
                  })}" data-v-83017533${_scopeId2}>\uFF08\u5E93\u5B58\u5269\u4F59\uFF1A<span text-red-5 data-v-83017533${_scopeId2}>${ssrInterpolate(unref(getStock))}</span>\u4EF6\uFF09</small><small style="${ssrRenderStyle(!unref(isAllCheckSku) ? null : {
                    display: "none"
                  })}" data-v-83017533${_scopeId2}>\uFF08\u603B\u5E93\u5B58\u5269\u4F59\uFF1A${ssrInterpolate(unref(getMaxStock))} \u4EF6\uFF09</small>`);
                } else {
                  return [createVNode(_component_el_input_number, {
                    ...
                    min: 1,
                    max: unref(getStock) !== 0 ? 99 : 1
                  }, null, 8, ["modelValue", "onUpdate:modelValue", "disabled", "max"]), withDirectives(createVNode("small", null, [createTextVNode("\uFF08\u5E93\u5B58\u5269\u4F59\uFF1A"), createVNode("span", {
                    "text-red-5": ""
                  }, toDisplayString(unref(getStock)), 1), createTextVNode("\u4EF6\uFF09")], 512), [[vShow, unref(isAllCheckSku)]]), withDirectives(createVNode("small", null, "\uFF08\u603B\u5E93\u5B58\u5269\u4F59\uFF1A" + toDisplayString(unref(getMaxStock)) + " \u4EF6\uFF09", 513), [[vShow, !unref(isAllCheckSku)]])];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_BtnElButton, mergeProps({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [createTextVNode(toDisplayString(unref(submitText) || "\u7ACB\u5373\u8D2D\u4E70"), 1)];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`<div rounded="t-6px" border-border-dark-300 relative flex-row-c-c border-2px bg-white p-2 text-0.9rem text-red-5 shadow-md border-default-dashed dark:bg-dark-6 class="${ssrRenderClass([{
              active: unref(isAllCheckSku)
            }, "all-price -translate-1/1"])}" data-v-83017533${_scopeId}><small block data-v-83017533${_scopeId}>\uFFE5</small><h3${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_incre_up, unref(allPrice)))} data-v-83017533${_scopeId}></h3><div style="${ssrRenderStyle(unref(allReduce).all ? null : {
              display: "none"
            })}" class="absolute w-full flex flex-col items-center font-600 -top-1.6rem" data-v-83017533${_scopeId}><small style="${ssrRenderStyle(unref(allReduce).activity.reduce ? null : {
              display: "none"
            })}" flex data-v-83017533${_scopeId}> -\uFFE5${ssrInterpolate(unref(allReduce).activity.reduce.toFixed(2))}</small></div></div></div></div>`);
          } else {
            return [createVNode("div", {
              ...
              default: withCtx(() => [createTextVNode(" \u65B0\u54C1 ")]),
              _: 1
            })) : createCommentVNode("", true), createVNode(_component_el_tag, {
              class: "mr-2",
              effect: "light",
              type: "info"
            }, {
              default: withCtx(() => {
                var _a3, _b3;
                return [createTextVNode(toDisplayString(((_a3 = _ctx.goodsInfo) == null ? void 0 : _a3.postage) ? `${(_b3 = _ctx.goodsInfo) == null ? void 0 : _b3.postage}\u5143\u8FD0\u8D39` : "\u514D\u8FD0\u8D39"), 1)];
              }),
              _: 1
              ...
              default: withCtx(() => {
                var _a3, _b3;
                return [createTextVNode(toDisplayString(((_a3 = _ctx.goodsInfo) == null ? void 0 : _a3.refundTime) ? `${(_b3 = _ctx.goodsInfo) == null ? void 0 : _b3.refundTime}\u65E5\u65E0\u7406\u7531\u9000\u8D27` : ""), 1)];
              }),
              _: 1
            })]), createVNode(_component_ClientOnly, null, {
              default: withCtx(() => {
                var _a3;
                return [createVNode(_component_BtnCollectGoods, {
            ...
            }, toDisplayString((_g = _ctx.goodsInfo) == null ? void 0 : _g.name), 1), createVNode("div", {
              "mb-4": "",
              "flex-row-bt-c": ""
            }, [createVNode("small", {
              "float-left": "",
              "opacity-90": ""
            }, "\u9500\u552E\u4EF7\uFF08\u5143\uFF09\uFF1A"), createVNode("div", {
              class: "righjt"
            }, [createVNode("span", {
              "text-1.4em": "",
              "text-red-5": "",
              "font-700": ""
            }, [createTextVNode("\uFFE5 "), withDirectives(createVNode("span", null, null, 512), [[_directive_incre_up, (_h = _ctx.goodsInfo) == null ? void 0 : _h.price]])]), createVNode("small", {
              style: {
                "text-decoration": "line-through",
                "opacity": "0.9"
              },
              "text-0.8em": "",
              "text-bluegray-3": ""
            }, [createTextVNode("\uFFE5 "), withDirectives(createVNode("span", null, null, 512), [[_directive_incre_up, (_i = _ctx.goodsInfo) == null ? void 0 : _i.costPrice]])])])]), unref(sizeList).length ? (openBlock(), createBlock("div", {
              key: 0,
              class: "card"
            }, [createVNode("small", null, "\u89C4 \u683C"), createVNode(_component_el_form_item, {
              prop: "size",
              required: "",
              "mt-1": ""
            }, {
              error: withCtx(() => [createVNode("small", {
                "pl-2": "",
                "text-red-5": ""
              }, "\u8BF7\u9009\u62E9\u89C4\u683C")]),
              ...
              _: 1
            })])) : createCommentVNode("", true), unref(colorList).length ? (openBlock(), createBlock("div", {
              key: 1,
              class: "card"
            }, [createVNode("small", null, "\u989C \u8272"), createVNode(_component_el_form_item, {
              prop: "color",
              required: "",
              "mt-1": ""
            }, {
              ...
              _: 1
            })])) : createCommentVNode("", true), unref(comboList).length ? (openBlock(), createBlock("div", {
              key: 2,
              class: "card"
            }, [createVNode("small", null, "\u5957 \u9910"), createVNode(_component_el_form_item, {
              prop: "combo",
              required: "",
              "mt-1": ""
            }, {
              ...
              _: 1
            })])) : createCommentVNode("", true)]), !_ctx.goodsSku || !_ctx.goodsSku.length ? (openBlock(), createBlock("div", {
              key: 0,
              class: "h-12rem w-full text-center leading-12rem"
            }, " \u6682\u672A\u5F00\u552E ")) : createCommentVNode("", true), createVNode("div", {
              class: "card"
            }, [createVNode("small", null, "\u6570 \u91CF"), createVNode(_component_el_form_item, {
              prop: "quantity",
              required: "",
              "mt-2": ""
            }, {
              ...
              default: withCtx(() => [createTextVNode(" \u52A0\u5165\u8D2D\u7269\u8F66 ")]),
              _: 1
            }, 8, ["disabled", "onClick"]), createVNode("div", {
              class: "relative flex-row-c-c flex-1 shadow shadow-[var(--el-color-info-light-3)]"
              ...
              default: withCtx(() => [createTextVNode(toDisplayString(unref(submitText) || "\u7ACB\u5373\u8D2D\u4E70"), 1)]),
              _: 1
            }, 8, ["disabled", "onClick"])), [[_directive_loading, unref(fullscreenLoading), void 0, {
              fullscreen: true,
              lock: true
            }]]), createVNode("div", {
              rounded: "t-6px",
              ...
              block: ""
            }, "\uFFE5"), withDirectives(createVNode("h3", null, null, 512), [[_directive_incre_up, unref(allPrice)]]), withDirectives(createVNode("div", {
              class: "absolute w-full flex flex-col items-center font-600 -top-1.6rem"
            }, [withDirectives(createVNode("small", {
              flex: ""
            }, " -\uFFE5" + toDisplayString(unref(allReduce).activity.reduce.toFixed(2)), 513), [[vShow, unref(allReduce).activity.reduce]])], 512), [[vShow, unref(allReduce).all]])], 2)])])];
          }
        }),
        _: 1
      }, _parent));
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const getPreImages = computed(() => {
      var _a2;
      return (_a2 = comment.images) == null ? void 0 : _a2.map((p) => p = `${BaseUrlImg + p}?imageView2/0/format/webp/interlace/1/q/50`);
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_text, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createTextVNode(toDisplayString(getRateComm(_ctx.comment.rate)), 1)];
          }
        }),
        _: 1
      }, _parent));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.comment.video) {
              _push2(`<div class="group relative mr-2 flex-row-c-c flex-shrink-0 cursor-pointer overflow-hidden border-1px rounded-4px border-default-dashed" h-5rem w-5rem backdrop-blur-12px md:h-6rem md:w-6rem style="${ssrRenderStyle({
                "background-color": "rgba(73, 73, 73, 0.4)"
              })}"${_scopeId}><i class="transition-200 group-hover:bg-dark" i-solar:play-circle-bold z-1 bg-light p-3${_scopeId}></i><div absolute left-0 top-0${_scopeId}>`);
            ...
            }, null, 8, ["preview-src-list", "src"])) : createCommentVNode("", true)])], 8, ["onClick"])) : createCommentVNode("", true), (openBlock(true), createBlock(Fragment, null, renderList(_ctx.comment.images, (p) => {
      ...
      _push(ssrRenderComponent(_component_CardElImage, {
        style: [((_a2 = _ctx.skuItem) == null ? void 0 : _a2.image) ? null : {
          display: "none"
        }, {
          "width": "3rem",
          "height": "3rem"
      ...
      _push(`<small>${ssrInterpolate(getProps(_ctx.skuItem))}</small></div><div class="mt-2 w-full flex cursor-pointer justify-end">`);
      _push(ssrRenderComponent(_component_el_text, {
        type: "primary",
        style: {
          "margin-left": "0.4rem"
      ...
      _push(ssrRenderComponent(_component_ListAutoIncre, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [(openBlock(true), createBlock(Fragment, null, renderList(unref(commentList), (p) => {
        ...
        _push2(ssrRenderComponent(_component_el_dialog, {
          ...
          default: withCtx((_, _push3, _parent2, _scopeId) => {
            if (_push3) {
              ...
              return [unref(isShowVideo) ? (openBlock(), createBlock("video", {
                key: 0,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_el_collapse_item, {
          ...
          title: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<li text-4 my-2 font-700 style="${ssrRenderStyle({
                "list-style": "circle"
              })}"${_scopeId2}> \u5E38\u89C1\u95EE\u9898\uFF1F <i i-solar:question-circle-broken p-2${_scopeId2}></i></li>`);
            } else {
              ...
              }, [createTextVNode(" \u5E38\u89C1\u95EE\u9898\uFF1F "), createVNode("i", {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              return [createVNode("div", null, [createTextVNode(" 1\u3001\u5982\u4F55\u4E0B\u5355\u8D2D\u4E70\u5546\u54C1\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u5728\u60A8\u6D4F\u89C8\u5546\u54C1\u65F6\uFF0C\u70B9\u51FB\u201C\u52A0\u5165\u8D2D\u7269\u8F66\u201D\uFF0C\u786E\u8BA4\u8D2D\u7269\u8F66\u4E2D\u7684\u5546\u54C1\uFF0C\u7136\u540E\u70B9\u51FB\u201C\u7ED3\u7B97\u5E76\u4ED8\u6B3E\u201D\uFF0C\u9009\u62E9\u4ED8\u6B3E\u65B9\u5F0F\u548C\u6536\u8D27\u5730\u5740\u5373\u53EF\u4E0B\u5355\u8D2D\u4E70\u3002 ")]), createVNode("div", null, [createTextVNode(" 2\u3001\u5546\u54C1\u53D1\u8D27\u65F6\u95F4\u662F\u591A\u4E45\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u901A\u5E38\u60C5\u51B5\u4E0B\uFF0C\u6211\u4EEC\u5C06\u572824\u5C0F\u65F6\u5185\u53D1\u8D27\u3002\u5982\u679C\u51FA\u73B0\u7279\u6B8A\u60C5\u51B5\uFF0C\u4F8B\u5982\u8282\u5047\u65E5\u7B49\uFF0C\u6211\u4EEC\u5C06\u63D0\u524D\u5728\u7F51\u7AD9\u4E0A\u8FDB\u884C\u901A\u77E5\u3002 ")]), createVNode("div", null, [createTextVNode(" 3\u3001\u5982\u4F55\u67E5\u8BE2\u6211\u7684\u8BA2\u5355\u72B6\u6001\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u60A8\u53EF\u4EE5\u5728\u201C\u6211\u7684\u8BA2\u5355\u201D\u4E2D\u67E5\u770B\u6240\u6709\u8BA2\u5355\u7684\u72B6\u6001\uFF0C\u5305\u62EC\u5F85\u4ED8\u6B3E\u3001\u5F85\u53D1\u8D27\u3001\u5DF2\u53D1\u8D27\u7B49\u72B6\u6001\u3002 ")]), createVNode("div", null, [createTextVNode(" 4\u3001\u662F\u5426\u652F\u6301\u8D27\u5230\u4ED8\u6B3E\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u76EE\u524D\u6211\u4EEC\u6682\u65F6\u4E0D\u652F\u6301\u8D27\u5230\u4ED8\u6B3E\uFF0C\u4EC5\u652F\u6301\u5728\u7EBF\u652F\u4ED8\u3002 ")])];
            }
          }),
          _: 1
        }, _parent2, _scopeId));
        ...
        return [createVNode(_component_el_collapse_item, {
          ...
          default: withCtx(() => [createVNode("div", null, [createTextVNode(" 1\u3001\u5982\u4F55\u4E0B\u5355\u8D2D\u4E70\u5546\u54C1\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u5728\u60A8\u6D4F\u89C8\u5546\u54C1\u65F6\uFF0C\u70B9\u51FB\u201C\u52A0\u5165\u8D2D\u7269\u8F66\u201D\uFF0C\u786E\u8BA4\u8D2D\u7269\u8F66\u4E2D\u7684\u5546\u54C1\uFF0C\u7136\u540E\u70B9\u51FB\u201C\u7ED3\u7B97\u5E76\u4ED8\u6B3E\u201D\uFF0C\u9009\u62E9\u4ED8\u6B3E\u65B9\u5F0F\u548C\u6536\u8D27\u5730\u5740\u5373\u53EF\u4E0B\u5355\u8D2D\u4E70\u3002 ")]), createVNode("div", null, [createTextVNode(" 2\u3001\u5546\u54C1\u53D1\u8D27\u65F6\u95F4\u662F\u591A\u4E45\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u901A\u5E38\u60C5\u51B5\u4E0B\uFF0C\u6211\u4EEC\u5C06\u572824\u5C0F\u65F6\u5185\u53D1\u8D27\u3002\u5982\u679C\u51FA\u73B0\u7279\u6B8A\u60C5\u51B5\uFF0C\u4F8B\u5982\u8282\u5047\u65E5\u7B49\uFF0C\u6211\u4EEC\u5C06\u63D0\u524D\u5728\u7F51\u7AD9\u4E0A\u8FDB\u884C\u901A\u77E5\u3002 ")]), createVNode("div", null, [createTextVNode(" 3\u3001\u5982\u4F55\u67E5\u8BE2\u6211\u7684\u8BA2\u5355\u72B6\u6001\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u60A8\u53EF\u4EE5\u5728\u201C\u6211\u7684\u8BA2\u5355\u201D\u4E2D\u67E5\u770B\u6240\u6709\u8BA2\u5355\u7684\u72B6\u6001\uFF0C\u5305\u62EC\u5F85\u4ED8\u6B3E\u3001\u5F85\u53D1\u8D27\u3001\u5DF2\u53D1\u8D27\u7B49\u72B6\u6001\u3002 ")]), createVNode("div", null, [createTextVNode(" 4\u3001\u662F\u5426\u652F\u6301\u8D27\u5230\u4ED8\u6B3E\uFF1F "), createVNode("br"), createTextVNode(" \u7B54\uFF1A\u76EE\u524D\u6211\u4EEC\u6682\u65F6\u4E0D\u652F\u6301\u8D27\u5230\u4ED8\u6B3E\uFF0C\u4EC5\u652F\u6301\u5728\u7EBF\u652F\u4ED8\u3002 ")])]),
          _: 1
        })];
      }
    }),
  ...
  _push(`<li text-4 my-2 mb-4 font-700 style="${ssrRenderStyle({
    "list-style": "circle"
  })}"> \u8D2D\u4E70\u987B\u77E5\uFF1A </li><p style="${ssrRenderStyle({
    "text-indent": "2em",
    "line-height": "1.4em"
  })}" opacity-80> \u5546\u54C1\u5C55\u793A\u7684\u5212\u7EBF\u4EF7\u6216\u6307\u5BFC\u4EF7\u53EF\u80FD\u662F\u5546\u54C1\u5236\u9020\u5382\u5546\u7684\u96F6\u552E\u5E02\u573A\u6307\u5BFC\u4EF7\u3001\u54C1\u724C\u4E13\u67DC\u4EF7\u3001\u5546\u54C1\u540A\u724C\u4EF7\u6216\u8BE5\u5546\u54C1\u5728\u6781\u7269\u5708\u4E0A\u66FE\u7ECF\u5C55\u793A\u8FC7\u7684\u9500\u552E\u4EF7\uFF1B\u7531\u4E8E\u5730\u533A\u3001\u65F6\u95F4\u7684\u4E0D\u540C\u548C\u5E02\u573A\u6CE2\u52A8\uFF0C\u54C1\u724C\u4E13\u67DC\u6807\u4EF7\u3001\u5546\u54C1\u540A\u724C\u4EF7\u7B49\u53EF\u80FD\u4F1A\u4E0E\u60A8\u8D2D\u7269\u65F6\u5C55\u793A\u7684\u4E0D\u4E00\u81F4\uFF0C\u8BE5\u4EF7\u683C\u4EC5\u4F9B\u60A8\u53C2\u8003\u3002 \u56E0\u7CFB\u7EDF\u7F13\u5B58\u66F4\u65B0\u5EF6\u8FDF\u7B49\u4E0D\u786E\u5B9A\u6027\u60C5\u51B5\uFF0C\u53EF\u80FD\u5BFC\u81F4\u4EF7\u683C\u663E\u793A\u5F02\u5E38\uFF0C\u5546\u54C1\u5177\u4F53\u552E\u4EF7\u8BF7\u4EE5\u8BA2\u5355\u7ED3\u7B97\u9875\u4EF7\u683C\u4E3A\u51C6\u3002 \u82E5\u60A8\u5BF9\u5546\u54C1\u5C55\u793A\u6709\u7591\u95EE\uFF0C\u6B22\u8FCE\u54A8\u8BE2\u5BA2\u670D\u3002 \u4E3A\u4FDD\u62A4\u5E7F\u5927\u6D88\u8D39\u8005\u7684\u5229\u76CA\uFF0C\u6781\u7269\u5708\u62B5\u5236\u56E4\u79EF\u5C45\u5947\u7B49\u6270\u4E71\u5E02\u573A\u7684\u884C\u4E3A\uFF0C\u6211\u4EEC\u4F1A\u5BF9\u5546\u54C1\u7684\u4E0B\u5355\u8FDB\u884C\u98CE\u9669\u63A7\u5236\uFF0C\u5E76\u4FDD\u7559\u53D6\u6D88\u975E\u6B63\u5E38\u8D2D\u4E70\u8BA2\u5355\u4E4B\u6743\u5229\u3002 </p></div>`);
}
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_tab_pane, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(`<h3 style="${ssrRenderStyle(!((_a2 = _ctx.goodsInfo) == null ? void 0 : _a2.description) ? null : {
                    display: "none"
                  })}" mb-4 ml-2 data-v-56c92d63${_scopeId2}>${ssrInterpolate((_b = _ctx.goodsInfo) == null ? void 0 : _b.name)}</h3>`);
                    ...
                    _push3(ssrRenderComponent(_component_el_text, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        ...
                        if (_push4) {
                          ...
                          return [createTextVNode(toDisplayString((_b2 = _ctx.goodsInfo) == null ? void 0 : _b2.refundTime) + "\u65E5\u65E0\u7406\u7531\u9000\u6362\u8D27", 1)];
                        }
                      }),
                      _: 1
                    }, _parent3, _scopeId2));
                  ...
                  return [withDirectives(createVNode("h3", {
                    "mb-4": "",
                    "ml-2": ""
                  }, toDisplayString((_h = _ctx.goodsInfo) == null ? void 0 : _h.name), 513), [[vShow, !((_i = _ctx.goodsInfo) == null ? void 0 : _i.description)]]), createVNode(_component_ClientOnly, null, {
                    default: withCtx(() => {
                      var _a22, _b2;
                      return [((_a22 = _ctx.goodsInfo) == null ? void 0 : _a22.description) ? (openBlock(), createBlock(_component_v_md_preview, {
                        key: 0,
                        class: "markdown mb-4",
                    ...
                    "leading-2em": "",
                    "border-default-dashed": ""
                  }, [createVNode("small", null, " \u53D1\u8D27\u5730\uFF1A" + toDisplayString((((_j = _ctx.goodsInfo) == null ? void 0 : _j.province) || "") + (((_k = _ctx.goodsInfo) == null ? void 0 : _k.city) || "") + ((_l = _ctx.goodsInfo) == null ? void 0 : _l.district)), 1), createVNode("br"), createVNode("small", null, [createTextVNode(" \u4FDD\u969C\uFF1A "), ((_m = _ctx.goodsInfo) == null ? void 0 : _m.refundTime) ? (openBlock(), createBlock(_component_el_text, {
                    key: 0
                  }, {
                    default: withCtx(() => {
                      var _a22;
                      return [createTextVNode(toDisplayString((_a22 = _ctx.goodsInfo) == null ? void 0 : _a22.refundTime) + "\u65E5\u65E0\u7406\u7531\u9000\u6362\u8D27", 1)];
                    }),
                    _: 1
            ...
            _push2(ssrRenderComponent(_component_el_tab_pane, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  return [createVNode(_component_GoodsCommentList, {
            ...
            _push2(ssrRenderComponent(_component_el_tab_pane, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [createVNode(_component_GoodsOtherTmp)];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            ...
            return [createVNode(_component_el_tab_pane, {
              ...
              default: withCtx(() => {
                ...
                return [withDirectives(createVNode("h3", {
                  "mb-4": "",
                  "ml-2": ""
                }, toDisplayString((_a2 = _ctx.goodsInfo) == null ? void 0 : _a2.name), 513), [[vShow, !((_b = _ctx.goodsInfo) == null ? void 0 : _b.description)]]), createVNode(_component_ClientOnly, null, {
                  default: withCtx(() => {
                    var _a22, _b2;
                    return [((_a22 = _ctx.goodsInfo) == null ? void 0 : _a22.description) ? (openBlock(), createBlock(_component_v_md_preview, {
                      key: 0,
                  ...
                  "leading-2em": "",
                  "border-default-dashed": ""
                }, [createVNode("small", null, " \u53D1\u8D27\u5730\uFF1A" + toDisplayString((((_c = _ctx.goodsInfo) == null ? void 0 : _c.province) || "") + (((_d = _ctx.goodsInfo) == null ? void 0 : _d.city) || "") + ((_e = _ctx.goodsInfo) == null ? void 0 : _e.district)), 1), createVNode("br"), createVNode("small", null, [createTextVNode(" \u4FDD\u969C\uFF1A "), ((_f = _ctx.goodsInfo) == null ? void 0 : _f.refundTime) ? (openBlock(), createBlock(_component_el_text, {
                  key: 0
                }, {
                  default: withCtx(() => {
                    var _a22;
              ...
              default: withCtx(() => [createVNode(_component_GoodsOtherTmp)]),
              _: 1
            })];
          }
        }),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ListGoodsListSsr = __nuxt_component_2$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-d7be2537>`);
      _push(ssrRenderComponent(_component_NuxtLayout, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="goods-detail mb-50vh layout-default" data-v-d7be2537${_scopeId}><section class="top pt-2" flex items-center data-v-d7be2537${_scopeId}>`);
            ...
            _push2(`</section><main class="mt-6 min-h-74vh w-full flex-row-bt-c flex-wrap gap-x-20" data-v-d7be2537${_scopeId}>`);
            ...
            _push2(`</main><section mt-5rem w-full flex flex-wrap justify-between border-0 border-default border-t="2px solid" class="bottom" data-v-d7be2537${_scopeId}><div class="left w-full pt-3rem md:w-2/3" data-v-d7be2537${_scopeId}><h2 tracking-0.1em data-v-d7be2537${_scopeId}><i i-solar:bolt-outline mr-2 bg-amber p-3.5 data-v-d7be2537${_scopeId}></i> \u5546\u54C1\u4ECB\u7ECD </h2>`);
            if ((_k = (_j = (_i = unref(goodsSku)) == null ? void 0 : _i.data) == null ? void 0 : _j.value) == null ? void 0 : _k.data) {
              ...
              _push2(`<div class="h-10rem w-full text-center leading-10rem" data-v-d7be2537${_scopeId}> \u6682\u65E0\u5185\u5BB9 </div>`);
            }
            _push2(`</div><div class="w-full pt-3rem md:w-1/3" data-v-d7be2537${_scopeId}><h2 mb-0.8em tracking-0.1em data-v-d7be2537${_scopeId}><i i-solar:bomb-emoji-outline mr-2 bg-lime p-4 data-v-d7be2537${_scopeId}></i> \u731C\u4F60\u559C\u6B22 </h2>`);
            ...
            return [createVNode("div", {
              class: "goods-detail mb-50vh layout-default"
            }, [createVNode("section", {
              class: "top pt-2",
              flex: "",
              "items-center": ""
            ...
            }, null, 8, ["gid", "name"])]), createVNode("main", {
              class: "mt-6 min-h-74vh w-full flex-row-bt-c flex-wrap gap-x-20"
              ...
              class: "left w-full pt-3rem md:w-2/3"
            }, [createVNode("h2", {
              "tracking-0.1em": ""
            }, [createVNode("i", {
              ...
              "bg-amber": "",
              "p-3.5": ""
            }), createTextVNode(" \u5546\u54C1\u4ECB\u7ECD ")]), ((_z = (_y = (_x = unref(goodsSku)) == null ? void 0 : _x.data) == null ? void 0 : _y.value) == null ? void 0 : _z.data) ? (openBlock(), createBlock(_component_GoodsDetailTabs, {
              key: 0,
              class: "mt-10 min-h-800px w-full overflow-hidden rounded-4px shadow-sm md:w-680px dark:opacity-90",
            ...
            }, " \u6682\u65E0\u5185\u5BB9 "))]), createVNode("div", {
              class: "w-full pt-3rem md:w-1/3"
            }, [createVNode("h2", {
              "mb-0.8em": "",
              "tracking-0.1em": ""
            }, [createVNode("i", {
              ...
              "bg-lime": "",
              "p-4": ""
            }), createTextVNode(" \u731C\u4F60\u559C\u6B22 ")]), createVNode(_component_ListGoodsListSsr, {
              class: "grid grid-cols-2 grid-gap-x-4 grid-gap-y-2",
              dto: {
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d7be2537"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-xMnwTV-f.mjs.map
