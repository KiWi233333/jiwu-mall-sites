import { u as useUserStore, a5 as useHead, D as appName, B as BaseUrlImg, A as useRoute, i as isTrue, n as navigateTo, _ as __nuxt_component_0, f as __nuxt_component_2$1, aR as getCommCategory, S as StatusCode, e as __nuxt_component_2, b as _export_sfc } from '../server.mjs';
...
import { P as PostStatus, k as getPostPageSelf } from './post-VFNrEwmr.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col" }, _attrs))}><div class="flex items-center border-gray-400">`);
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "h-2rem w-2rem" }, [
                        ...
                        createVNode("span", { truncate: "" }, toDisplayString(p == null ? void 0 : p.name), 1)
                      ])
                    ];
                  }
                }),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    status: {},
    isAutoStop: { type: Boolean, default: false }
  },
      ...
      _push(ssrRenderComponent(_component_el_tabs, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_el_tab_pane, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      createVNode(_component_UserPostInfoList, {
                        dto: unref(searchDTO),
                        status: p.dto.status
                      }, null, 8, ["dto", "status"])
                    ];
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(tabsList), (p) => {
            ...
            return [
              createVNode(_component_ClientOnly, null, {
                default: withCtx(() => {
                  var _a;
                  return [
                    ((_a = unref(user).userInfo) == null ? void 0 : _a.id) ? (openBlock(), createBlock("div", {
                      key: 0,
                      ...
                      createVNode("div", {
                        ...
                        createVNode("h2", { "tracking-1": "" }, " \u6211\u7684\u5E16\u5B50 ")
                      ]),
                      createVNode("div", {
                        "mt-4": "",
                        "min-h-100vh": ""
                      }, [
                        createVNode(_component_UserPostMangerTabs)
                      ])
...
//# sourceMappingURL=post-869nT9bc.mjs.map
