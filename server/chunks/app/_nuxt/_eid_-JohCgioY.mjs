import { t as useRoute, n as navigateTo, c as useSeoMeta, B as BaseUrlImg, _ as __nuxt_component_0, b as _export_sfc } from '../server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-9f846494><div class="img relative h-120px w-full overflow-hidden rounded-t-inherit md:h-160px" data-v-9f846494>`);
        ...
        _push(ssrRenderComponent(_component_el_tag, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              return [createTextVNode(" -\uFFE5" + toDisplayString(unref(currency)((_c2 = _ctx.data) == null ? void 0 : _c2.price).subtract((_d2 = _ctx.data) == null ? void 0 : _d2.eventPrice)), 1)];
            }
          }),
          _: 1
        }, _parent));
      ...
      })}" data-v-9f846494> \uFFE5${ssrInterpolate(unref(currency)(_ctx.data.price))}</small></p></div></div>`);
    };
  }
});
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if ((_b2 = (_a2 = unref(list).data.value) == null ? void 0 : _a2.data) == null ? void 0 : _b2.id) {
              ...
              ssrRenderList((_g = unref(list).data.value) == null ? void 0 : _g.data.list, (p) => {
                _push2(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(_component_EventGoodsEvent, {
                        data: p
                      }, null, _parent3, _scopeId2));
                    } else {
                      return [createVNode(_component_EventGoodsEvent, {
                        data: p
                      }, null, 8, ["data"])];
                    }
                  }),
              ...
              _push2(`<!--]--></div></section><div style="${ssrRenderStyle(unref(isNot) ? null : {
                display: "none"
              })}" class="w-full flex-row-c-c flex-1 text-center"${_scopeId}> \u6682\u65E0\u6D3B\u52A8\u5546\u54C1 </div>`);
            ...
            return [((_m = (_l = unref(list).data.value) == null ? void 0 : _l.data) == null ? void 0 : _m.id) ? (openBlock(), createBlock("div", {
              key: 0,
              class: "layout-default"
            }, [createVNode("div", {
              class: "mx-a min-h-100vh w-full flex flex-col rounded-10px p-4 shadow md:w-80% v-card"
            }, [createVNode("div", {
              class: "bg absolute relative left-0 h-300px w-full overflow-hidden rounded-t-10px"
            }, [createVNode("img", {
            ...
            }, toDisplayString(unref(getEventStatus).title), 3), createVNode("h2", {
              "text-light": "",
              class: "mt-4 cursor-pointer text-center tracking-1 transition-300 hover:scale-106 md:text-3xl"
            }, toDisplayString((_o = unref(list).data.value) == null ? void 0 : _o.data.title), 1), createVNode("small", {
              class: "my-2 text-[var(--el-color-info)]"
            }, [createTextVNode(" \u6D3B\u52A8\u65F6\u95F4\uFF1A "), createVNode("small", {
              class: "opacity-60"
            }, toDisplayString((_p = unref(list).data.value) == null ? void 0 : _p.data.startTime), 1), createTextVNode(" ~ "), createVNode("small", {
              class: "opacity-60"
            }, toDisplayString((_q = unref(list).data.value) == null ? void 0 : _q.data.endTime), 1)])])]), withDirectives(createVNode("section", {
              class: "list min-h-80vh flex-1 pb-6"
            }, [createVNode("h3", {
              "my-6": "",
              "border-l-0": "",
              "border-r-0": "",
              ...
              "text-center": "",
              "border-default": ""
            }, " \u6D3B\u52A8\u5546\u54C1 "), createVNode("div", {
              grid: "~ cols-2 md:cols-4 gap-4 md:gap-6"
              ...
              return openBlock(), createBlock(_component_NuxtLink, {
                ...
                default: withCtx(() => [createVNode(_component_EventGoodsEvent, {
                  data: p
                }, null, 8, ["data"])]),
                _: 2
              }, 1032, ["to"]);
            }), 128))])], 512), [[vShow, !unref(isNot)]]), withDirectives(createVNode("div", {
              class: "w-full flex-row-c-c flex-1 text-center"
            }, " \u6682\u65E0\u6D3B\u52A8\u5546\u54C1 ", 512), [[vShow, unref(isNot)]]), ((_t = (_s = unref(list).data.value) == null ? void 0 : _s.data) == null ? void 0 : _t.details) ? (openBlock(), createBlock("section", {
              key: 0
            }, [createVNode(_component_v_md_preview, {
              text: (_v = (_u = unref(list).data.value) == null ? void 0 : _u.data) == null ? void 0 : _v.details,
              "preview-class": "vuepress-markdown-body"
            }, null, 8, ["text"])])) : createCommentVNode("", true)])])) : createCommentVNode("", true)];
          }
        }),
        _: 1
      }, _parent));
...
//# sourceMappingURL=_eid_-JohCgioY.mjs.map
