    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_scrollbar, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<section${ssrRenderAttrs(mergeProps({ class: "grid" }, ssrGetDirectiveProps(_ctx, _directive_auto_animate)))} data-v-a390a5c5${_scopeId}><!--[-->`);
              ...
              _push2(ssrRenderComponent(_component_nuxt_link, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      createVNode("div", { class: "flex items-center gap-3 transition-200 hover:text-[var(--el-color-info)]" }, [
                        createVNode("h4", {
                          style: {
                            color: getColor[i] || ""
                          }
                        }, toDisplayString(i + 1), 5),
                        createVNode("span", { class: "w-12rem flex-1 truncate" }, toDisplayString(p.title), 1),
                        createVNode("small", {
                          "ml-a": "",
                          "w-6rem": "",
                          flex: "",
                          ...
                          createTextVNode(" " + toDisplayString(p.views) + " ", 1),
                          p.isEssence ? (openBlock(), createBlock(_component_el_tag, {
                            key: 0,
                            size: "small",
                            effect: "dark",
                            style: { "padding": "0 0.2rem" },
                      ...
                      p.cover ? (openBlock(), createBlock("div", {
                        key: 0,
            ...
            if (unref(postList).length === 0 && unref(pageInfo).current > 0) {
              _push2(ssrRenderComponent(_component_el_empty, { description: "\u6682\u65E0\u5E16\u5B50" }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            _push2(`</section>`);
            ...
            return [
              withDirectives((openBlock(), createBlock("section", { class: "grid" }, [
                ...
                unref(postList).length === 0 && unref(pageInfo).current > 0 ? (openBlock(), createBlock(_component_el_empty, {
                  key: 0,
                  description: "\u6682\u65E0\u5E16\u5B50"
                })) : createCommentVNode("", true)
              ])), [
...
//# sourceMappingURL=Rank-l5ic3HVq.mjs.map
