import { b as _export_sfc, u as useUserStore, i as isTrue, B as BaseUrlImg, E as ElMessage, A as useRoute, c as useSeoMeta, D as appName, d as appKeywords, S as StatusCode, e as __nuxt_component_2, f as __nuxt_component_2$1, _ as __nuxt_component_0, a as _sfc_main$2$1, j as useHttp } from '../server.mjs';
import { _ as _sfc_main$3 } from './PreLoading-Jnbo7kLW.mjs';
...
import { _ as _sfc_main$4 } from './TagList-HC8gpUm-.mjs';
...
import { g as getCommPostDetailHttp } from './post-VFNrEwmr.mjs';
...
import { t as toReactive } from './index-daJZwzbi.mjs';
import { _ as _sfc_main$5 } from './UserPostTotal-Kn3Agu8X.mjs';
import { _ as _sfc_main$6 } from './SigninCard-zf-9e3x9.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ "w-full": "" }, _attrs))} data-v-fad20028><div class="forms sticky bottom-1rem" data-v-fad20028>`);
                  ...
                  _push3(ssrRenderComponent(_component_el_select, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(parentIdList), (p) => {
                            var _a2;
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(`<div${ssrRenderAttrs(mergeProps({
                    style: ((_a2 = unref(form).images) == null ? void 0 : _a2.length) ? null : { display: "none" }
                  ...
                  return [
                    withDirectives((openBlock(), createBlock("div", null, [
                      ...
                      [vShow, (_b2 = unref(form).images) == null ? void 0 : _b2.length],
                ...
                default: withCtx(() => {
                  ...
                  return [
                    withDirectives((openBlock(), createBlock("div", null, [
                      ...
                      [vShow, (_a2 = unref(form).images) == null ? void 0 : _a2.length],
                      [_directive_auto_animate]
                    ])
                  ];
                }),
      ...
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_OtherPreLoading, { class: "w-full" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_OtherPreLoading, { class: "w-full" })
            ];
          }
        })
      }, _parent));
...
const __nuxt_component_12_lazy = defineAsyncComponent(() => import('./CateGoryLine-OOeXYtEG.mjs').then((m) => m.default || m));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-58ced6c4>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_OtherPreLoading, { class: "h-100vh w-full flex-row-c-c" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_component_OtherPreLoading, { class: "h-100vh w-full flex-row-c-c" })
                  ];
                }
              })
            }, _parent2, _scopeId));
            ...
            return [
              createVNode(_component_ClientOnly, null, {
                ...
                default: withCtx(() => {
                  ...
                  return [
                    ((_a2 = unref(user).userInfo) == null ? void 0 : _a2.id) ? (openBlock(), createBlock("main", { key: 0 }, [
                      createVNode("div", { class: "group fixed left-0 top-0 z-0 h-30vh w-full shadow-md shadow-inset" }, [
                        createVNode(_component_CardElImage, {
                        ...
                        createVNode(_component_BtnSwitch, { class: "absolute right-2rem top-2rem z-2 op-0 group-hover:op-100" })
                      ]),
                      createVNode("div", {
                        relative: "",
                        "z-1": "",
                        ...
                        createVNode("div", {
                          ...
                          createVNode("section", {
                            ...
                            createVNode("div", {
                              ...
                              }, toDisplayString((_c = unref(post)) == null ? void 0 : _c.title), 1),
                              createVNode("div", { class: "group flex items-center" }, [
                                createVNode("small", {
                                  flex: "",
                                  "items-center": "",
                                  "font-600": "",
                                  ...
                                  createTextVNode(" " + toDisplayString((_g = (_f = unref(post)) == null ? void 0 : _f.user) == null ? void 0 : _g.nickname), 1)
                                ]),
                                createVNode("small", {
                                  "ml-2": "",
                                  "opacity-50": ""
                                }, "\u53D1\u5E16\u65F6\u95F4\uFF1A" + toDisplayString((_h = unref(post)) == null ? void 0 : _h.createTime), 1),
                                ((_i = unref(post)) == null ? void 0 : _i.userId) !== ((_j = unref(user).userInfo) == null ? void 0 : _j.id) ? (openBlock(), createBlock(_component_BtnElButton, {
                                  key: 0,
                                  type: "info",
                                  round: "",
                                  plain: "",
                              ...
                              ((_m = unref(post)) == null ? void 0 : _m.content) ? (openBlock(), createBlock(_component_v_md_preview, {
                                key: 0,
                                "preview-class": "vuepress-markdown-body",
                                text: (_n = unref(post)) == null ? void 0 : _n.content
                              }, null, 8, ["text"])) : createCommentVNode("", true),
                              createVNode(_component_el_divider, { style: { "margin": "0.25rem 0", "opacity": "0.5" } }),
                              ...
                              }, null, 8, ["post-id", "likes"])) : createCommentVNode("", true)
                            ]),
                            createVNode(_component_ClientOnly, { fallback: "\u52A0\u8F7D\u4E2D" }, {
                              default: withCtx(() => {
                                var _a3, _b3;
                                return [
                                  createVNode(_component_CardCommentPreview, {
                          ...
                          createVNode("section", {
                            ...
                            ((_p = unref(post)) == null ? void 0 : _p.user) ? (openBlock(), createBlock(_component_CardUserPostTotal, {
                              key: 0,
                              dto: {
                            ...
                            createVNode(_component_UserInfoSigninCard, { class: "p-4 border-default card-default md:p-6" })
                          ])
                        ])
                      ])
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-58ced6c4"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-XmvgHVHy.mjs.map
