import { defineComponent, getCurrentInstance, inject, ref, watch, nextTick, openBlock, createElementBlock, normalizeClass, unref, normalizeStyle, computed, onUpdated, createVNode, provide, renderSlot, useSlots, reactive, onUnmounted, withDirectives, vShow, createCommentVNode } from 'vue';
import { h as buildProps, z as definePropType, A as mutable, ap as throwError$1, j as useNamespace, F as ElIcon, H as arrow_left_default, I as arrow_right_default, G as close_default, ao as useDeprecated, N as plus_default, w as withInstall, P as withNoopInstall, l as _export_sfc$1, au as isUndefined, k as isNumber } from '../server.mjs';
import { j as useResizeObserver, k as useDocumentVisibility, l as useWindowFocus, m as computedEager, U as UPDATE_MODEL_EVENT } from './event-9ZI5GX64.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    if (!rootTabs)
      throwError$1(COMPONENT_NAME$2, "<el-tabs><el-tab-bar /></el-tabs>");
...
const TabNav = defineComponent({
  ...
  setup(props, {
    ...
    const rootTabs = inject(tabsRootContextKey);
    if (!rootTabs)
      throwError$1(COMPONENT_NAME$1, `<el-tabs><tab-nav /></el-tabs>`);
    const ns = useNamespace("tabs");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    if (!tabsRoot)
      throwError$1(COMPONENT_NAME, "usage: <el-tabs><el-tab-pane /></el-tabs/>");
...
//# sourceMappingURL=tab-pane-VfJmI_8q.mjs.map
