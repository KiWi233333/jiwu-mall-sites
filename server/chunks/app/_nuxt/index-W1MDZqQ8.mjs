import { b as _export_sfc, A as useRoute, s as search_default, E as ElMessage, _ as __nuxt_component_0, f as __nuxt_component_2$1, h as ElButton, e as __nuxt_component_2 } from '../server.mjs';
...
import { u as useStorage } from './index-daJZwzbi.mjs';
...
const __nuxt_component_11_lazy = defineAsyncComponent(() => import('./GoodsList-jFkO4WGn.mjs').then((m) => m.default || m));
const __nuxt_component_12_lazy = defineAsyncComponent(() => import('./PostList-Wuy5b0GJ.mjs').then((m) => m.default || m));
              ...
              createVNode(_component_ClientOnly, null, {
                default: withCtx(() => [
                  createVNode("div", {
                    ...
                    createVNode("div", { class: "left sticky top-6rem" }),
                    createVNode("div", {
                      "min-h-80vh": "",
                      flex: "",
                      "flex-col": "",
                      ...
                      createVNode("header", { class: "group mb-2rem flex-row-c-c cursor-pointer text-center text-2rem tracking-0.4em" }, [
                        createVNode("i", { class: "i-solar:magnifer-outline mr-4 inline-block transform-origin-[right_bottom] text-0.6em transition-200 transition-all group-hover:-rotate-10" }),
                        createTextVNode(" \u641C\u7D22 ")
                      ]),
                      createVNode("div", { class: "h-2.6rem w-1/1 flex-row-c-c" }, [
                      ...
                      createVNode("div", { class: "mt-3 flex items-start md:h-2rem" }, [
                        createVNode("div", {
                          class: [{ "h-6rem md:h-3rem": unref(isShowOrder) }, "grid grid-cols-4 h-0 flex-1 gap-2 overflow-hidden opacity-80 transition-300 transition-height md:grid-cols-8"]
                        }, [
                        ...
                        createVNode(_component_BtnElButton, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(isShowOrder) ? "\u6536\u8D77" : "\u7B5B\u9009"), 1)
                          ]),
                          _: 1
                        }, 8, ["onClick"])
                      ]),
                          ...
                          createVNode("div", {
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList(unref(searchHistoryList), (p, i) => {
                              return openBlock(), createBlock(_component_ElTag, {
                                ...
                                default: withCtx(() => [
                                  createVNode("span", { "pr-0.3em": "" }, toDisplayString(p), 1)
                                ]),
                                _: 2
                      ...
                      withDirectives(createVNode("small", {
                        "my-2": "",
                        "opacity-80": ""
                      }, toDisplayString(`\u641C\u7D22\u7ED3\u679C`) + " " + toDisplayString(unref(getTotal)), 513), [
                      ...
                      withDirectives(createVNode(_component_el_tabs, {
                        ...
                        default: withCtx(() => [
                          createVNode(_component_el_tab_pane, {
                            ...
                            default: withCtx(() => [
                              createVNode(_component_LazyListGoodsList, {
                          ...
                          createVNode(_component_el_tab_pane, {
                            ...
                            default: withCtx(() => [
                              createVNode(_component_LazyCommPostList, {
                                ref_key: "postListRef",
                                ref: postListRef,
                                dto: unref(dto),
                      ...
                      !unref(showResult) ? (openBlock(), createBlock("div", {
                        key: 0,
                        "min-h-80vh": "",
                        "animate-fade-in": ""
                      }, [
                    ...
                    createVNode("div", { class: "right sticky top-6rem" })
                  ])
                ]),
                _: 1
              })
...
//# sourceMappingURL=index-W1MDZqQ8.mjs.map
