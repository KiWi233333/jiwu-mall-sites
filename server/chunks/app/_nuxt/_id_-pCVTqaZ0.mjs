...
import { u as useUserStore, t as useRoute, Y as useHead, v as appName, n as navigateTo, E as ElMessage, B as BaseUrlImg, Z as star_filled_default, S as StatusCode, $ as useError, f as ElMessageBox, _ as __nuxt_component_0, e as __nuxt_component_0$1, g as ElButton, a as _sfc_main$2$1, K as zoom_in_default, a0 as close_bold_default, a1 as caret_right_default, b as _export_sfc } from '../server.mjs';
...
import { g as getResToken, O as OssFileType, b as uploadOssFile, d as deleteOssFile } from './index-hfRePjpv.mjs';
...
import { w as watchDebounced, u as useStorage } from './event-9ZI5GX64.mjs';
import { _ as __nuxt_component_1$2 } from './ElImage-j3i6j_3Z.mjs';
...
import { g as getOrdersInfoById, O as OrdersStatus, t as toOrdersComment } from './index-bcSo8MsF.mjs';
  ...
  setup(__props, {
    ...
    async function onChange(file, fileList) {
      ...
      if (index === -1) {
        const {
          data,
          code
        } = await getResToken(OssFileType.IMAGE, user.getToken);
    ...
    async function onChangeVideo(file, fileList) {
      ...
      if (index === -1) {
        const {
          data,
          code
        } = await getResToken(OssFileType.VIDEO, user.getToken);
        if (code === StatusCode.SUCCESS) {
          file.key = data.key;
    ...
    async function onRemove(removeFile) {
      ...
      ElMessageBox.confirm("\u786E\u5B9A\u5220\u9664\u8BE5\u56FE\u7247?", "\u5220\u9664\u63D0\u793A", {
        ...
        const {
          code
        } = await deleteOssFile(item.key, user.getToken);
    ...
    function onVideoRemove(file) {
      ElMessageBox.confirm("\u786E\u5B9A\u5220\u9664\u8BE5\u89C6\u9891?", "\u5220\u9664\u63D0\u793A", {
        ...
        const {
          code
        } = await deleteOssFile(file.key, user.getToken);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "upload-group flex"
      }, _attrs))} data-v-ee64029b>`);
      _push(ssrRenderComponent(_component_el_upload, {
        ...
        file: withCtx(({
          ...
          if (_push2) {
            _push2(`<div class="group relative h-6rem w-6rem cursor-pointer" data-v-ee64029b${_scopeId}><img class="h-full w-full" style="${ssrRenderStyle({
              "object-fit": "cover"
            })}"${ssrRenderAttr("src", file.url)} alt="\u9884\u89C8" loading="lazy" fit="cover" data-v-ee64029b${_scopeId}><div style="${ssrRenderStyle(file.status === "success" ? null : {
              display: "none"
            })}" class="absolute left-0 top-0 h-full w-full flex-row-c-c bg-dark-100 opacity-0 transition-300 group-hover:opacity-80" data-v-ee64029b${_scopeId}>`);
            ...
            _push2(`</div><div style="${ssrRenderStyle(file.status === "uploading" ? null : {
              display: "none"
            })}" class="absolute top-0 z-1 h-full w-full flex-row-c-c bg-light dark:bg-dark-1" data-v-ee64029b${_scopeId}>`);
            ...
            return [createVNode("div", {
              class: "group relative h-6rem w-6rem cursor-pointer"
            }, [createVNode("img", {
              class: "h-full w-full",
              style: {
                "object-fit": "cover"
              ...
              loading: "lazy",
              fit: "cover"
            }, null, 8, ["src"]), withDirectives(createVNode("div", {
              ...
              class: "h-1.2rem w-1.2rem cursor-pointer text-[#fff] hover:text-[var(--el-color-primary)]",
              onClick: ($event) => onPreview(file)
            }, null, 8, ["onClick"]), createVNode(_component_ElIconCloseBold, {
              class: "absolute right-2 top-2 h-1rem w-1rem cursor-pointer text-[#fff] hover:text-[var(--el-color-danger)]",
              onClick: ($event) => onRemove(file)
            }, null, 8, ["onClick"])], 512), [[vShow, file.status === "success"]]), withDirectives(createVNode("div", {
              ...
              percentage: file.percentage,
              status: file.status === "success" ? "success" : ""
            }, null, 8, ["percentage", "status"])], 512), [[vShow, file.status === "uploading"]]), createVNode("small", {
              class: "absolute top-0 z-10 text-[var(--el-color-danger)]"
            }, "\u4E0A\u4F20\u5931\u8D25")])];
          }
        }),
      ...
      ssrRenderTeleport(_push, (_push2) => {
        _push2(ssrRenderComponent(_component_el_dialog, {
          ...
          default: withCtx((_, _push3, _parent2, _scopeId) => {
            if (_push3) {
              _push3(`<img style="${ssrRenderStyle(unref(isPicture) ? null : {
                display: "none"
              })}" w-full${ssrRenderAttr("src", unref(imgUrl))} alt="Kiwi2333 \u6781\u7269\u5708" data-v-ee64029b${_scopeId}><video style="${ssrRenderStyle(!unref(isPicture) ? null : {
                display: "none"
              })}"${ssrRenderAttr("src", unref(videoUrl))} preload="auto" controls h-full w-full data-v-ee64029b${_scopeId}></video>`);
            } else {
              return [withDirectives(createVNode("img", {
                "w-full": "",
                src: unref(imgUrl),
                alt: "Kiwi2333 \u6781\u7269\u5708"
              }, null, 8, ["src"]), [[vShow, unref(isPicture)]]), withDirectives(createVNode("video", {
                ref_key: "videoRef",
                ref: videoRef,
                src: unref(videoUrl),
                preload: "auto",
                ...
                "h-full": "",
                "w-full": ""
              }, null, 8, ["src"]), [[vShow, !unref(isPicture)]])];
            }
          }),
          _: 1
        }, _parent));
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_card_el_image = __nuxt_component_1$2;
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "goods flex"
      }, _attrs))}>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, {
    ...
    const dto = useStorage(`jiwu_order_comment_${orderItem.id}`, reactive({
    ...
    watch([() => uploadFilesRef.value.images, () => uploadFilesRef.value.video], (val) => {
      if (val[0]) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_rate, {
        ...
        "allow-half": "",
        "show-text": "",
        colors: ["var(--el-color-black-light-5)", "var(--el-color-warning-light-3)", "var(--el-color-warning)"],
      ...
      _push(ssrRenderComponent(_component_el_checkbox, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode("small", null, "\u63A8 \u8350")];
          }
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_el_checkbox, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode("small", null, "\u533F \u540D")];
          }
        }),
        _: 1
      }, _parent));
  ...
  setup(__props) {
    ...
    const order = useAsyncData(async () => {
      const {
        data,
        code
      } = await getOrdersInfoById(orderId.value, user.getToken);
      if (code === StatusCode.SUCCESS) {
    ...
    async function onSubmit() {
      ...
      const {
        code
      } = await toOrdersComment(order.data.value.id, JSON.parse(JSON.stringify(dtoList.value.map((p) => p.dto))), user.getToken);
      if (code === StatusCode.SUCCESS) {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode(_component_ClientOnly, null, {
              default: withCtx(() => {
                var _a2;
                return [unref(isExpire) ? withDirectives((openBlock(), createBlock("div", {
                  key: 0,
                  ...
                  flex: "",
                  "items-center": ""
                }, [createTextVNode(" \u8BA2\u5355\u8BC4\u4EF7 "), createVNode("i", {
                  ...
                  class: "tra sticky bottom-1rem mt-4 flex items-center rounded-10px p-3 shadow v-card"
                  ...
                  _: 1
                }, 8, ["onClick"])])])), [[_directive_loading, unref(isLoading), void 0, {
                  fullscreen: true,
                  lock: true
                  ...
                  "w-8rem": "",
                  alt: "\u{1F389}"
                }), createVNode("h3", null, "\u8BC4\u4EF7\u5DF2\u5B8C\u6210"), createVNode("div", {
                  class: "mt-2"
                }, [createVNode(_component_el_button, {
                  type: "primary",
...
//# sourceMappingURL=_id_-pCVTqaZ0.mjs.map
