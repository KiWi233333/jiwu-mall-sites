import { t as useRoute, c as useSeoMeta, u as useUserStore, x as clearError, n as navigateTo, B as BaseUrlImg, y as compareObjects, E as ElMessage, _ as __nuxt_component_0, e as __nuxt_component_0$1, a as _sfc_main$2$1, d as __nuxt_component_2$1, S as StatusCode, f as ElMessageBox, b as _export_sfc } from '../server.mjs';
...
import { useSSRContext, defineComponent, computed, mergeProps, unref, withCtx, createVNode, renderSlot, createTextVNode, toDisplayString, ref, openBlock, createBlock, createCommentVNode, isRef, Fragment, renderList, resolveComponent, reactive } from 'vue';
import { a as getCommCategoryList } from './category-HtxOPKX5.mjs';
...
import { g as getResToken, O as OssFileType, u as uploadOssFileSe, a as getOssErrorCode, d as deleteOssFile } from './index-hfRePjpv.mjs';
import { E as ElNotification } from './index-KIyZNhTO.mjs';
import { E as ElTag } from './index-3Hd0ipYT.mjs';
import { P as PostStatus, b as getPostStatusList, c as getCommPostDetailBySelf, u as updateCommPost, d as addCommPost, e as delCommPost, h as hardDelCommPost } from './post-uKGC7P8z.mjs';
import { c as useSessionStorage } from './event-9ZI5GX64.mjs';
  ...
  setup(__props, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "flex flex-col"
      }, _attrs))} data-v-d94657d1><div class="max-w-20rem w-16rem flex items-center border-gray-400 rounded-1rem border-default-dashed" data-v-d94657d1><i i-solar:asteroid-line-duotone mx-2 p-0.5em opacity-70 data-v-d94657d1></i>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [createVNode("div", {
                      ...
                      loading: "lazy",
                      src: ("BaseUrlImg" in _ctx ? _ctx.BaseUrlImg : unref(BaseUrlImg)) + (p == null ? void 0 : p.image)
                    }, null, 8, ["src"]), createVNode("span", null, toDisplayString(p == null ? void 0 : p.name), 1)])];
                  }
                }),
                _: 2
              }, _parent2, _scopeId));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            return [createVNode("span", {
              class: "flex items-center text-light"
            }, [renderSlot(_ctx.$slots, "pre", {}, void 0, true), createTextVNode(" " + toDisplayString((_b = unref(getStatus)) == null ? void 0 : _b.title), 1)])];
          }
        }),
        _: 3
      }, _parent));
  ...
  setup(__props, {
    ...
    async function getPostInfo(id) {
      ...
      if (res.code === StatusCode.SUCCESS) {
        ...
        form.value = {
          ...res.data,
          images,
          tags: ((_b = res.data.tags) == null ? void 0 : _b.trim()) ? (_c = res.data.tags) == null ? void 0 : _c.split(",") : []
        };
        theData.value = {
          ...res.data,
          images,
          tags: ((_d = res.data.tags) == null ? void 0 : _d.trim()) ? (_e = res.data.tags) == null ? void 0 : _e.split(",") : []
        };
        if (form.value.cover) {
          coverList.value = [{
            file: void 0,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_el_form, mergeProps({
        ...
        model: unref(form),
        class: "form"
      }, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isLoading), void 0, {
        fullscreen: true
      })), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div flex-row-bt-c flex-wrap data-v-af0d7d0b${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_InputOssFileUpload, {
                    ...
                    multiple: false,
                    limit: 1,
                    class: "w-full w-full md:w-16rem md:w-auto",
                    "input-class": "h-18rem card-default md:h-10rem md:w-16rem w-full mr-2 flex-row-c-c flex-shrink-0",
                    "upload-quality": 0.5,
                    onErrorMsg: (msg) => {
            ...
            _push2(ssrRenderComponent(_component_el_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_CommCategorySelect, {
                    ...
                    default: withCtx((data, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                              ...
                              if (_push5) {
                                ...
                                ssrRenderList(data.data, (p) => {
                                  _push5(ssrRenderComponent(_component_el_radio, {
                                    key: p.id,
                                    style: {
                                      "border": "1px solid rgb(255 255 255 / 25.3%)",
                                      "padding": "0.2rem 0.6rem",
                                      "margin": "1rem 0.5rem 0 0"
                                    },
                                    label: p.id,
                                    class: "card-defult relative overflow-hidden shadow-sm"
                                  }, {
                                    default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`${ssrInterpolate(p.name)}`);
                                      } else {
                                        return [createTextVNode(toDisplayString(p.name), 1)];
                                      }
                                    }),
                                    _: 2
                                  }, _parent5, _scopeId4));
                                ...
                                return [(openBlock(true), createBlock(Fragment, null, renderList(data.data, (p) => {
                        ...
                        return [data.data ? (openBlock(), createBlock(_component_el_radio_group, {
                          key: 0,
                          modelValue: unref(form).categoryId,
                          "onUpdate:modelValue": ($event) => unref(form).categoryId = $event
                        }, {
                          default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(data.data, (p) => {
                            return openBlock(), createBlock(_component_el_radio, {
                              key: p.id,
                              style: {
                                "border": "1px solid rgb(255 255 255 / 25.3%)",
                  ...
                  return [createVNode(_component_CommCategorySelect, {
                    modelValue: unref(form).categoryId,
                    "onUpdate:modelValue": ($event) => unref(form).categoryId = $event
                  }, {
                    default: withCtx((data) => [data.data ? (openBlock(), createBlock(_component_el_radio_group, {
                      key: 0,
                      modelValue: unref(form).categoryId,
                      "onUpdate:modelValue": ($event) => unref(form).categoryId = $event
                    }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_el_select, {
                    ...
                    class: "tags-in w-16rem rounded-1rem border-default",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [(openBlock(true), createBlock(Fragment, null, renderList(unref(tagsList), (item) => {
                          return openBlock(), createBlock(_component_el_option, {
                            key: item,
                            label: item,
                            value: item
                  ...
                  return [createVNode(_component_el_select, {
                    ...
                    default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(unref(tagsList), (item) => {
                      return openBlock(), createBlock(_component_el_option, {
                        key: item,
                        label: item,
                        value: item
            ...
            _push2(ssrRenderComponent(_component_el_form_item, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [createVNode(_component_FormMdEdit, {
                    "model-value": unref(form).content,
                    "onUpdate:modelValue": ($event) => unref(form).content = $event,
                    "path-list": unref(form).images,
                    "onUpdate:pathList": ($event) => unref(form).images = $event,
            ...
            return [createVNode("div", {
              ...
              default: withCtx(() => [createVNode(_component_CommCategorySelect, {
                modelValue: unref(form).categoryId,
                "onUpdate:modelValue": ($event) => unref(form).categoryId = $event
              }, {
                default: withCtx((data) => [data.data ? (openBlock(), createBlock(_component_el_radio_group, {
              ...
              default: withCtx(() => [createVNode(_component_FormMdEdit, {
                "model-value": unref(form).content,
                "onUpdate:modelValue": ($event) => unref(form).content = $event,
                "path-list": unref(form).images,
                "onUpdate:pathList": ($event) => unref(form).images = $event,
      ...
      _push(`<div class="sticky bottom-1rem z-99 flex-row-bt-c rounded-t-2 p-4 shadow-sm border-default card-default" data-v-af0d7d0b>`);
        ...
        _push(ssrRenderComponent(_component_BtnElButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [createTextVNode(" \u56DE\u6536\u7AD9\xA0 ")];
            }
          }),
          _: 1
        }, _parent));
        ...
        _push(ssrRenderComponent(_component_BtnElButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [createTextVNode(" \u5F7B\u5E95\u5220\u9664\xA0 ")];
            }
          }),
          _: 1
        }, _parent));
      ...
      _push(ssrRenderComponent(_component_BtnElButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createTextVNode(" \u5B58\u8349\u7A3F\xA0 ")];
          }
        }),
        _: 1
      }, _parent));
      _push(ssrRenderComponent(_component_BtnElButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createTextVNode(toDisplayString(unref(getPostStatus)) + "\xA0 ", 1)];
          }
        }),
        _: 1
      }, _parent));
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-af0d7d0b"]]);
          ...
          if (_push2) {
            ...
            return [createVNode(_component_ClientOnly, null, {
              default: withCtx(() => {
                ...
                return [((_a2 = unref(user).userInfo) == null ? void 0 : _a2.id) ? (openBlock(), createBlock("div", {
                  key: 0
                  ...
                  key: 1,
                  "my-6": ""
                }, " \u7F16\u8F91\u5E16\u5B50 \u270D ")), createVNode(_component_CommNewPostForm, {
                  cid: `${((_e = _ctx.$route.query) == null ? void 0 : _e.cid) || ""}`,
                  onSubmit: (res) => resultObj.value = res
                }, null, 8, ["cid", "onSubmit"])])) : (openBlock(), createBlock("div", {
                  key: 1,
                  ...
                  footer: withCtx(() => [createVNode(_component_BtnElButton, {
                    ...
                    onClick: ($event) => {
                      var _a3, _b2, _c2, _d2;
                      return ("clearError" in _ctx ? _ctx.clearError : unref(clearError))({
                        redirect: ((_b2 = (_a3 = _ctx.$route) == null ? void 0 : _a3.query) == null ? void 0 : _b2.rollback) ? (_d2 = (_c2 = _ctx.$route) == null ? void 0 : _c2.query) == null ? void 0 : _d2.rollback.toString() : "/"
                      });
                    }
                  }, {
                    default: withCtx(() => [createTextVNode(" \u8FD4\u56DE ")]),
                    _: 2
                  }, 1032, ["onClick"]), createVNode(_component_BtnElButton, {
                    type: "danger",
                    onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/user/post")
                  }, {
                    default: withCtx(() => [createTextVNode(" \u6211\u7684\u5E16\u5B50 ")]),
                    _: 1
                  }, 8, ["onClick"])]),
                  _: 2
                }, 1032, ["msg", "icon"])]))])) : createCommentVNode("", true)];
              }),
              _: 2
            }, 1024)];
          }
...
//# sourceMappingURL=new-bIOXRWqv.mjs.map
