...
import { c as getGoodsListByPage, _ as __nuxt_component_1 } from './index-VI4pRKfC.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    transiton: { default: "fade-bt-list" }
  },
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CardGoodsBox = __nuxt_component_1;
      _push(ssrRenderComponent(_component_ListAutoIncre, mergeProps({
        ...
        load: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "load", {}, void 0, true)
            ];
          }
        }),
          ...
          if (_push2) {
            if (_ctx.showMoreText) {
              _push2(`<p style="${ssrRenderStyle(unref(isNoMore) || unref(isNot) ? null : { display: "none" })}" class="w-1/1 py-8" text-center text-bluegray tracking-1 data-v-5ed468e7${_scopeId}>${ssrInterpolate(unref(isNoMore) ? "\u6682\u65E0\u66F4\u591A\u5546\u54C1" : "\u6682\u65E0\u5546\u54C1")}</p>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              _ctx.showMoreText ? withDirectives((openBlock(), createBlock("p", {
                key: 0,
                class: "w-1/1 py-8",
                "text-center": "",
                "text-bluegray": "",
                "tracking-1": ""
              }, toDisplayString(unref(isNoMore) ? "\u6682\u65E0\u66F4\u591A\u5546\u54C1" : "\u6682\u65E0\u5546\u54C1"), 513)), [
...
const GoodsList = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5ed468e7"]]);

export { GoodsList as default };
//# sourceMappingURL=GoodsList-jFkO4WGn.mjs.map
