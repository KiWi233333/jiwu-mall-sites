import { h as buildProps, j as useNamespace, O as iconPropType, k as isNumber, F as ElIcon, a9 as check_default, G as close_default, w as withInstall, P as withNoopInstall, b as _export_sfc, l as _export_sfc$1, u as useUserStore, S as StatusCode, aa as shopping_cart_full_default, ab as money_default, ac as credit_card_default, ad as van_default, ae as chat_dot_square_default, B as BaseUrlImg, af as useAddressStore, t as useRoute, v as appName, Y as useHead, g as ElButton, E as ElMessage, ag as useCheckXXSText, f as ElMessageBox, n as navigateTo, _ as __nuxt_component_0, e as __nuxt_component_0$1, ah as circle_plus_filled_default } from '../server.mjs';
...
import { _ as _sfc_main$b } from './DelayTimer-F8E5aGkX.mjs';
...
import { C as CHANGE_EVENT, b as useDateFormat, e as useWebNotification } from './event-9ZI5GX64.mjs';
...
import { g as getBillsPage, B as BillsType } from './bills-1cJh0vG3.mjs';
import { a as getDelivertOrders, O as OrdersStatus, P as PayType, p as pushOrdersItems, b as payOrders, c as cancelOrders, u as updateOrders, r as refundOrders, d as checkDeliveryOrders, e as deleteOrders } from './index-bcSo8MsF.mjs';
...
import { g as getEventsInfo } from './index-I9ZbP2md.mjs';
import currency from 'currency.js';
import { g as getGoodsSkuByGid, a as getGoodsSkuByIds } from './sku-V9DXfY1F.mjs';
...
var Steps = /* @__PURE__ */ _export_sfc$1(_sfc_main$a, [["__file", "steps.vue"]]);
...
var Step = /* @__PURE__ */ _export_sfc$1(_sfc_main$9, [["__file", "item.vue"]]);
...
var TimelineItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["__file", "timeline-item.vue"]]);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode("span", {
              class: "hidden overflow-hidden truncate md:inline"
            }, "\u5237\u65B0"), createVNode("i", {
      ...
      _push(ssrRenderComponent(_component_el_timeline, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<!--]-->`);
            _push2(ssrRenderComponent(_component_el_timeline_item, {
              style: unref(delivery).data.value ? null : {
                display: "none"
              },
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(`<div${_scopeId2}><div class="el-timeline-item__content pb-1"${_scopeId2}> \u5DF2\u53D1\u8D27\uFF0C <span${ssrRenderAttrs(mergeProps({
                    class: "mr-2 cursor-pointer select-none text-[var(--el-color-success)] active:underline hover:underline"
                  }, ssrGetDirectiveProps(_ctx, _directive_copying, (_a2 = unref(delivery).data.value) == null ? void 0 : _a2.deliveryNum, void 0, {
                    toast: true
                  })))}${_scopeId2}>${ssrInterpolate((_b2 = unref(delivery).data.value) == null ? void 0 : _b2.deliveryNum)}</span>`);
                  _push3(ssrRenderComponent(_component_el_text, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [createTextVNode(toDisplayString(unref(isFold) ? "\u6298\u53E0" : "\u5C55\u5F00"), 1)];
                      }
                    }),
                    _: 1
                  }, _parent3, _scopeId2));
                  ...
                  return [createVNode("div", null, [createVNode("div", {
                    ...
                    default: withCtx(() => [createTextVNode(toDisplayString(unref(isFold) ? "\u6298\u53E0" : "\u5C55\u5F00"), 1)]),
                    _: 1
                  }, 8, ["type", "onClick"])]), createVNode("div", {
                    class: [{
                      "h-6em": unref(isFold)
                    }, "h-0 flex flex-col overflow-hidden rounded-6px pt-1 leading-1.4em opacity-90 transition-height"]
                  }, [createVNode("small", null, "\u8BA2\u5355\u53F7\uFF1A" + toDisplayString((_i = unref(delivery).data.value) == null ? void 0 : _i.deliveryNum), 1), createVNode("small", null, "\u5FEB\u9012\u5355\u53F7\uFF1A" + toDisplayString((_j = unref(delivery).data.value) == null ? void 0 : _j.deliveryNum), 1), createVNode("small", null, "\u6536\u8D27\u5730\u5740\uFF1A" + toDisplayString((_k = unref(delivery).data.value) == null ? void 0 : _k.sendAddress), 1), createVNode("small", null, "\u53D1\u8D27\u5730\u5740\uFF1A" + toDisplayString((_l = unref(delivery).data.value) == null ? void 0 : _l.deliverAddress), 1)], 2)])];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            ...
            return [(openBlock(true), createBlock(Fragment, null, renderList(unref(list), (p) => {
            ...
            }), 128)), withDirectives(createVNode(_component_el_timeline_item, {
              ...
              default: withCtx(() => {
                ...
                return [createVNode("div", null, [createVNode("div", {
                  ...
                  class: "mr-2 cursor-pointer select-none text-[var(--el-color-success)] active:underline hover:underline"
                }, [createTextVNode(toDisplayString((_a2 = unref(delivery).data.value) == null ? void 0 : _a2.deliveryNum), 1)])), [[_directive_copying, (_b2 = unref(delivery).data.value) == null ? void 0 : _b2.deliveryNum, void 0, {
                  toast: true
                }]]), createVNode(_component_el_text, {
                  size: "small",
                  class: "cursor-pointer select-none active:underline hover:underline",
                ...
                }, [createVNode("small", null, "\u8BA2\u5355\u53F7\uFF1A" + toDisplayString((_c = unref(delivery).data.value) == null ? void 0 : _c.deliveryNum), 1), createVNode("small", null, "\u5FEB\u9012\u5355\u53F7\uFF1A" + toDisplayString((_d = unref(delivery).data.value) == null ? void 0 : _d.deliveryNum), 1), createVNode("small", null, "\u6536\u8D27\u5730\u5740\uFF1A" + toDisplayString((_e = unref(delivery).data.value) == null ? void 0 : _e.sendAddress), 1), createVNode("small", null, "\u53D1\u8D27\u5730\u5740\uFF1A" + toDisplayString((_f = unref(delivery).data.value) == null ? void 0 : _f.deliverAddress), 1)], 2)])];
              }),
              _: 1
            }, 8, ["timestamp"]), [[vShow, unref(delivery).data.value]]), renderSlot(_ctx.$slots, "default", {
              data: unref(delivery)
            })];
          }
        }),
        ...
        _push(ssrRenderComponent(_component_el_steps, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_component_el_step, {
                icon: "ElIconMoney" in _ctx ? _ctx.ElIconMoney : unref(money_default)
              }, {
                ...
                description: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [_ctx.active === unref(OrdersStatus).UN_PAID ? (openBlock(), createBlock(_component_OrderDelayTimer, {
                      key: 0,
                      date: new Date(props.date),
                      class: "font-600 text-[var(--el-color-danger)]",
                      onDelay: delayOrder
              ...
              return [createVNode(_component_el_step, {
                title: "\u63D0\u4EA4\u8BA2\u5355",
                icon: "ElIconShoppingCartFull" in _ctx ? _ctx.ElIconShoppingCartFull : unref(shopping_cart_full_default)
              }, null, 8, ["icon"]), createVNode(_component_el_step, {
                icon: "ElIconMoney" in _ctx ? _ctx.ElIconMoney : unref(money_default)
              }, {
                ...
                title: withCtx(() => [createVNode("strong", {
                  class: {
                    "text-[var(--el-color-danger)] ": _ctx.active === unref(OrdersStatus).UN_PAID
                  }
                }, " \u5F85\u652F\u4ED8 ", 2)]),
                description: withCtx(() => [_ctx.active === unref(OrdersStatus).UN_PAID ? (openBlock(), createBlock(_component_OrderDelayTimer, {
                  key: 0,
                  date: new Date(props.date),
                  class: "font-600 text-[var(--el-color-danger)]",
                  onDelay: delayOrder
                ...
                _: 1
              }, 8, ["icon"]), createVNode(_component_el_step, {
                title: "\u5F85\u53D1\u8D27",
                description: "48\u5C0F\u65F6\u5185\u53D1\u8D27",
                icon: "ElIconCreditCard" in _ctx ? _ctx.ElIconCreditCard : unref(credit_card_default)
              }, null, 8, ["icon"]), createVNode(_component_el_step, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        "md:p-3": "",
        "md:text-1em": ""
      }, _attrs, ssrGetDirectiveProps(_ctx, _directive_loading, unref(isUpdateLoading))))} data-v-33cab4ab><div class="${ssrRenderClass([{
        "is-event ": _ctx.data.activityId
      }, "relative w-2/7 md:w-8em"])}" data-v-33cab4ab>`);
      ...
      _push(ssrRenderComponent(_component_el_select, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [(openBlock(true), createBlock(Fragment, null, renderList(unref(skuList), (p) => {
      ...
      if (_ctx.data) {
        _push(`<small class="${ssrRenderClass({
          "text-[var(--el-color-error)]": (_a = unref(eventSkuList).get(_ctx.data.skuId)) == null ? void 0 : _a.eventPrice
        })}" data-v-33cab4ab>${ssrInterpolate(((_b = unref(eventSkuList).get(_ctx.data.skuId)) == null ? void 0 : _b.eventPrice) ? "\u6D3B\u52A8" : "")}\u4EF7\u683C\uFF1A\uFFE5${ssrInterpolate(unref(getGoodsPrices))}</small>`);
      } else {
        _push(`<!---->`);
      }
  ...
  setup(__props, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        flex: "",
        "items-end": ""
      }, _attrs))}><small class="relative flex flex-col"><div style="${ssrRenderStyle(props.modelValue > 0 ? null : {
        display: "none"
      })}" class="absolute bottom-1em right-0 mb-1 ml-a flex-row-c-c text-[var(--el-color-error)]"> - <span block>${ssrInterpolate(props.modelValue)}</span></div><div flex items-end justify-end> \u79EF\u5206\u5269\u4F59\uFF1A <div class="flex flex-col"><div>${ssrInterpolate(unref(user).userWallet.points)}</div></div></div></small>`);
      _push(ssrRenderComponent(_component_el_input_number, {
...
const __nuxt_component_5_lazy = defineAsyncComponent(() => import('./index-eePIGq3N.mjs').then((m) => m.default || m));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const orderStatusMap = /* @__PURE__ */ new Map([[OrdersStatus.READY, {
      banner: "\u63D0\u4EA4\u8BA2\u5355",
      submitText: "\u63D0\u4EA4\u8BA2\u5355",
      type: "primary",
      btnType: "primary"
    }], [OrdersStatus.UN_PAID, {
      banner: "\u5F85\u4ED8\u6B3E",
      submitText: "\u7ACB\u5373\u4ED8\u6B3E",
      type: "danger",
      btnType: "danger"
    }], [OrdersStatus.PAID, {
      banner: "\u5DF2\u4ED8\u6B3E\uFF0C\u7B49\u5F85\u53D1\u8D27\u{1F4E6}",
      submitText: "\u50AC\u53D1\u8D27",
      type: "primary",
      btnType: "primary"
    ...
    async function loadSkuItems() {
      ...
      const {
        data,
        code
      } = await getGoodsSkuByIds(skuIdList);
      if (code === StatusCode.SUCCESS) {
        data.forEach((sku) => {
    ...
    async function pushOrder(call) {
      ...
      const {
        ...
        message,
        code
      } = await pushOrdersItems(selectAddressId.value, items, useCheckXXSText(remark.value), user.getToken);
      if (code === StatusCode.SUCCESS) {
        order.$patch({
    ...
    async function payOrder(payType) {
      ...
      if (getFinalPrice.value.value > +user.userWallet.balance) {
        ElMessageBox.confirm("\u4F59\u989D\u4E0D\u8DB3\uFF0C\u662F\u5426\u524D\u5F80\u5145\u503C?", "\u4F59\u989D\u63D0\u793A", {
      ...
      try {
        const action = await ElMessageBox.confirm(`\u4F7F\u7528${str}\u652F\u4ED8 \uFFE5${getFinalPrice.value}\uFF1F`, "\u786E\u8BA4\u652F\u4ED8", {
        ...
        if (action === "confirm") {
          ...
          const {
            ...
            message,
            code
          } = await payOrders(order.orderId || order.orderInfo.id, PayType.WEALLET, selectPointsVal.value, selectVoucherId.value, user.getToken);
          if (code === StatusCode.SUCCESS) {
            ElNotification.success({
              title: "\u4ED8\u6B3E\u6210\u529F\uFF01",
    ...
    async function cancelOrder(orderId) {
      ...
      try {
        ...
        if (action === "confirm") {
          ...
          const {
            code
          } = await cancelOrders(orderId || order.orderInfo.id, user.getToken);
          isLoading.value = false;
          if (code === StatusCode.SUCCESS) {
            order.orderInfo.updateTime = useDateFormat(Date.now(), "YYYY-MM-DD HH:mm:ss").value.toString();
    ...
    async function updateOrder(orderId) {
      ...
      const {
        message,
        code
      } = await updateOrders(orderId, selectAddressId.value, remark.value || order.orderInfo.remark, user.getToken);
      isLoading.value = false;
      if (code === StatusCode.SUCCESS) {
        order.orderInfo.updateTime = useDateFormat(Date.now(), "YYYY-MM-DD HH:mm:ss").value.toString();
      ...
      try {
        ...
        if (action === "confirm") {
          ...
          const {
            message,
            code
          } = await refundOrders(orderId || order.orderInfo.id, user.getToken);
          isLoading.value = false;
          if (code === StatusCode.SUCCESS) {
            order.orderInfo.updateTime = useDateFormat(Date.now(), "YYYY-MM-DD HH:mm:ss").value.toString();
    ...
    async function checkDeliveryOrder() {
      ...
      try {
        ...
        if (action === "confirm") {
          ...
          const {
            code
          } = await checkDeliveryOrders(order.orderInfo.id, user.getToken);
          isLoading.value = false;
          if (code === StatusCode.SUCCESS) {
            order.orderInfo.updateTime = useDateFormat(Date.now(), "YYYY-MM-DD HH:mm:ss").value.toString();
    ...
    async function deleteOrder(orderId) {
      ...
      try {
        ...
        if (action === "confirm") {
          ...
          const {
            code
          } = await deleteOrders(orderId || order.orderInfo.id, user.getToken);
          isLoading.value = false;
          if (code === StatusCode.SUCCESS) {
            order.clearOrderItems();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _directive_loading = vLoading;
      const _directive_copying = resolveDirective("copying");
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-c39435a3>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode(_component_ClientOnly, null, {
              default: withCtx(() => {
                var _a2, _b;
                return [unref(user).isLogin && unref(order).pushOrderItems.length > 0 ? withDirectives((openBlock(), createBlock("div", {
                  key: 0,
                  class: "min-h-100vh tracking-0.1em layout-default-se"
                }, [createVNode("div", {
                  class: "group mb-2rem mt-1rem flex flex-row-bt-c flex-wrap select-none"
                }, [createVNode("div", {
                  class: "flex items-center"
                }, [createVNode(_component_NuxtLink, {
                  to: "/"
                }, {
                  default: withCtx(() => [createVNode(_component_card_el_image, {
                    loading: "lazy",
                    src: "/logo_title.png",
                  ...
                  default: withCtx(() => {
                    var _a3;
                    return [createTextVNode(toDisplayString((_a3 = unref(ordersTitle)) == null ? void 0 : _a3.banner) + " ", 1), unref(order).status === unref(OrdersStatus).UN_PAID ? (openBlock(), createBlock("div", {
                      key: 0,
                      inline: "",
                      truncate: ""
                    }, [createTextVNode(" \uFF1A "), createVNode(_component_OrderDelayTimer, {
                      date: new Date(unref(order).orderInfo.createTime)
                    }, null, 8, ["date"])])) : createCommentVNode("", true)];
                  }),
                  _: 1
                }, 8, ["type"])]), createVNode("div", {
                  class: "flex"
                }, [createVNode(_component_BtnReload, {
                  class: "group-hover:opacity-90 md:opacity-0",
                  onReload: reload
                }), createVNode(_component_BtnSwitch, {
                  class: "mr-0 group-hover:opacity-90 md:opacity-0"
                  ...
                  style: {
                    borderTopColor: `var(--el-color-${unref(ordersTitle).type})`
                  }
                ...
                }, null, 8, ["active", "date", "color"])) : createCommentVNode("", true), unref(isUpdate) ? (openBlock(), createBlock("div", {
                  key: "address-list",
                  class: "address-list w-full flex flex-col"
                }, [createVNode("h4", {
                  "mb-2": "",
                  "tracking-0.2em": ""
                }, [createTextVNode(" \u6536\u8D27\u5730\u5740\uFF1A "), withDirectives(createVNode("i", {
                  "opacity-0": "",
                ...
                }, null, 512), [[vShow, unref(isUpdate)]])]), createVNode(_component_ElDivider, {
                  style: {
                    "margin": "0.7rem 0"
                  },
                  "opacity-40": ""
                  ...
                  default: withCtx(() => [createVNode(_component_el_scrollbar, null, {
                    default: withCtx(() => [withDirectives((openBlock(), createBlock("ul", {
                      ...
                      return openBlock(), createBlock(_component_OrderAddressBoxSe, {
                        key: p.id,
                        address: p,
                        class: ["w-220px flex-shrink-0 overflow-hidden opacity-80 transition-200 dark:opacity-70", p.id === unref(selectAddressId) ? "border-[var(--el-color-primary)] dark:border-[var(--el-color-primary)]" : ""],
                        onClick: ($event) => updateAddressId(p.id)
                      }, {
                        btns: withCtx(() => [createVNode(_component_el_radio, {
                          label: p.id
                        }, null, 8, ["label"])]),
                        _: 2
                      }, 1032, ["address", "class", "onClick"]);
                    }), 128)), createVNode(_component_NuxtLink, {
                      key: "/user/address",
                      target: "_blank",
                      to: "/user/address",
                      ...
                      default: withCtx(() => [createVNode(_component_ElIconCirclePlusFilled, {
                        class: "h-4em w-4em opacity-40 transition-300"
                      }), createVNode("strong", {
                        class: "mt-2 opacity-40 transition-300"
                      }, "\u6DFB\u52A0\u65B0\u5730\u5740")]),
                      _: 1
                  ...
                  _: 1
                }, 8, ["modelValue", "onUpdate:modelValue", "disabled"])])) : createCommentVNode("", true)], 4)), [[_directive_loading, unref(isLoadAddressList)], [_directive_auto_animate]]), withDirectives(createVNode(_component_OrderAddressInfo, {
                  class: "border-default v-card",
                  address: unref(order).orderInfo
                }, null, 8, ["address"]), [[vShow, unref(order).status > unref(OrdersStatus).READY]]), createVNode("div", {
                  class: "order-item flex flex-col border-default v-card"
                }, [createVNode("h4", {
                  "mb-2": ""
                }, [createTextVNode(" \u9009\u8D2D\u5546\u54C1 "), unref(order).status === unref(OrdersStatus).READY ? (openBlock(), createBlock(_component_el_text, {
                  key: 0,
                  ...
                  default: withCtx(() => [createTextVNode(toDisplayString(unref(isEdit) ? "\u786E\u5B9A\u4FEE\u6539" : "\u4FEE\u6539"), 1)]),
                  _: 1
                }, 8, ["type", "onClick"])) : createCommentVNode("", true), createVNode(_component_ElDivider, {
                  style: {
                    "margin": "0.7rem 0"
                  },
                  "opacity-40": ""
                ...
                }), 128))]), createVNode("section", {
                  class: "border-default v-card"
                }, [createVNode("div", {
                  class: "flex-row-bt-c"
                }, [createVNode("span", null, "\u4EE3\u91D1\u5377"), createVNode(_component_el_select, {
                  ...
                  class: unref(voucherList).length === 0 || !unref(isEdit) ? "w-4.6rem" : "w-1/5",
                  placeholder: unref(voucherList).length ? "\u9009\u62E9\u4EE3\u91D1\u5377" : "\u6682\u65E0\u4EE3\u91D1\u5377"
                }, {
                  default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(unref(voucherList), (p) => {
                    return openBlock(), createBlock(_component_el_option, {
                      key: p,
                      label: p,
                      value: p
                  ...
                  _: 1
                }, 8, ["modelValue", "onUpdate:modelValue", "disabled", "class", "placeholder"])]), createVNode(_component_ElDivider, {
                  class: "opacity-40",
                  style: {
                    "margin": "0.8em 0"
                  }
                ...
                }, [createVNode("span", null, [createTextVNode(" \u79EF\u5206\u62B5\u6263 "), createVNode("small", {
                  "opacity-80": ""
                }, "100\u79EF\u5206\u4F4E1\u5143\uFF08\u6BCF\u5355\u4E0A\u965010000\u79EF\u5206\uFF09")]), unref(user).userWallet.points > 0 ? (openBlock(), createBlock(_component_OrderSelectPoints, {
                  key: 0,
                  ...
                  "font-600": "",
                  "opacity-40": ""
                }, " \u6682\u65E0\u79EF\u5206 "))])) : createCommentVNode("", true)]), createVNode("section", {
                  class: "flex-row-bt-c border-default v-card"
                }, [createTextVNode(" \u5907\u6CE8 "), createVNode("div", {
                  class: "w-10rem flex justify-end md:w-14rem"
                  ...
                  key: 1,
                  "text-right": ""
                }, toDisplayString(unref(order).orderInfo.remark || "\u6682\u65E0\u5907\u6CE8"), 1))])]), unref(order).orderInfo.status === unref(OrdersStatus).UN_PAID ? (openBlock(), createBlock("section", {
                  key: 0,
                  class: "border-default v-card"
                }, [createVNode("h4", {
                  "tracking-0.2em": ""
                }, [createTextVNode(" \u4ED8\u6B3E\u65B9\u5F0F "), createVNode(_component_ElDivider, {
                  style: {
                    "margin": "0.7rem 0"
                  },
                  "opacity-40": ""
                  ...
                  default: withCtx(() => [(openBlock(true), createBlock(Fragment, null, renderList(unref(payTypeList), (p) => {
                    return openBlock(), createBlock("div", {
                      ...
                      innerHTML: p.icon
                    }, null, 8, ["innerHTML"]), createVNode("small", {
                      "text-0.8rem": ""
                    }, [createTextVNode(toDisplayString(p.title) + " ", 1), (p == null ? void 0 : p.amount) ? (openBlock(), createBlock("span", {
                      key: 0
                    }, "\uFF08\u5269\u4F59\uFF1A" + toDisplayString(p == null ? void 0 : p.amount) + "\uFF09", 1)) : createCommentVNode("", true)])]), !p.disable ? (openBlock(), createBlock("div", {
                      key: 0,
                      flex: "",
                      "items-center": ""
                      ...
                      _: 2
                    }, 1032, ["label", "disable"])])) : (openBlock(), createBlock("small", {
                      key: 1,
                      "text-0.6rem": "",
                      "font-500": "",
                      "opacity-60": ""
                  ...
                  _: 1
                }, 8, ["modelValue", "onUpdate:modelValue", "disable"])])])) : createCommentVNode("", true), unref(order).status !== unref(OrdersStatus).READY ? (openBlock(), createBlock("section", {
                  key: 1,
                  class: "flex flex-col leading-2em opacity-80 border-default v-card"
                }, [createVNode("h4", {
                  "tracking-0.2em": ""
                }, [createTextVNode(" \u8BA2\u5355\u4FE1\u606F "), createVNode(_component_ElDivider, {
                  style: {
                    "margin": "0.7rem 0"
                  },
                  "opacity-40": ""
                })]), withDirectives((openBlock(), createBlock("small", {
                  class: "w-full flex-row-bt-c cursor-pointer"
                }, [createTextVNode(" \u8BA2\u5355\u53F7 "), createVNode("span", {
                  class: "transition-300 hover:text-[var(--el-color-info)] hover:underline"
                }, [createTextVNode(toDisplayString(unref(order).orderInfo.id) + " ", 1), createVNode("i", {
                  class: "i-solar:copy-outline p-2 opacity-60"
                })])])), [[_directive_copying, unref(order).orderInfo.id, void 0, {
                  toast: true
                }]]), withDirectives(createVNode("small", {
                  "w-full": "",
                  "flex-row-bt-c": ""
                }, [createTextVNode(" \u652F\u4ED8\u65F6\u95F4 "), createVNode("span", {
                  "opacity-80": "",
                  style: {
                    "font-family": "Helvetica"
                  }
                }, toDisplayString(unref(order).orderInfo.paidTime), 1)], 512), [[vShow, unref(order).orderInfo.paidTime]]), createVNode("small", {
                  "w-full": "",
                  "flex-row-bt-c": ""
                }, [createTextVNode(" \u66F4\u65B0\u65F6\u95F4 "), createVNode("span", {
                  "opacity-80": "",
                  style: {
                    "font-family": "Helvetica"
                  }
                }, toDisplayString(unref(order).orderInfo.updateTime), 1)]), createVNode("small", {
                  "w-full": "",
                  "flex-row-bt-c": ""
                }, [createTextVNode(" \u4E0B\u5355\u65F6\u95F4 "), createVNode("span", {
                  "opacity-80": "",
                  style: {
                    "font-family": "Helvetica"
                  }
                }, toDisplayString(unref(order).orderInfo.createTime), 1)])])) : createCommentVNode("", true), createVNode("section", {
                  class: "flex flex-col leading-2em border-default v-card"
                }, [createVNode("h4", {
                  "tracking-0.2em": ""
                }, " \u91D1\u989D\u660E\u7EC6 "), createVNode(_component_ElDivider, {
                  style: {
                    "margin": "0.6rem 0"
                  },
                  "opacity-40": ""
                ...
                }, [createTextVNode(" \u539F\u603B\u4EF7 "), createVNode("span", null, "\uFFE5" + toDisplayString(unref(getAllCoastPrice)), 1)]), withDirectives(createVNode("small", {
                  class: "w-full flex-row-bt-c opacity-80"
                }, [createTextVNode(" \u4F18\u60E0 "), createVNode("strong", {
                  class: "text-[var(--el-color-error)]"
                }, "-" + toDisplayString(`\uFFE5${unref(getReduce)}`), 1)], 512), [[vShow, unref(order).status > unref(OrdersStatus).UN_PAID && unref(getReduce) !== 0]]), createVNode("small", {
                  class: "w-full flex-row-bt-c opacity-80"
                }, [createTextVNode(" \u8FD0\u8D39 "), createVNode("span", null, toDisplayString(unref(getAllPostage).value > 0 ? `\uFFE5${unref(getAllPostage)}` : "\uFFE50.00"), 1)]), withDirectives(createVNode("small", {
                  class: "w-full flex-row-bt-c opacity-80"
                }, [createTextVNode(" \u4EE3\u91D1\u5377\u4F18\u60E0 "), createVNode("span", null, toDisplayString(unref(voucherList).length ? unref(selectVoucherId) : 0) + "\u5143", 1)], 512), [[vShow, unref(selectVoucherId) !== "" && unref(order).status <= unref(OrdersStatus).UN_PAID]]), withDirectives(createVNode("small", {
                  class: "w-full flex-row-bt-c opacity-80"
                }, [createTextVNode(" \u79EF\u5206\u62B5\u6263 "), createVNode("span", {
                  class: "text-[var(--el-color-error)]"
                }, " -" + toDisplayString(`\uFFE5${unref(currency)(unref(selectPointsVal) / 100)}`), 1)], 512), [[vShow, unref(selectPointsVal) > 0 && unref(order).status <= unref(OrdersStatus).UN_PAID]]), withDirectives(createVNode("small", {
                  class: "w-full flex-row-bt-c opacity-80"
                }, [createTextVNode(" \u6D3B\u52A8\u4F18\u60E0 "), createVNode("span", {
                  class: "text-[var(--el-color-error)]"
                }, " -" + toDisplayString(`\uFFE5${unref(currency)(unref(selectEventReduceVal) / 100)}`), 1)], 512), [[vShow, unref(selectEventReduceVal) > 0 && unref(order).status <= unref(OrdersStatus).UN_PAID]]), unref(getReduce) ? (openBlock(), createBlock("small", {
                  key: 0,
                  class: "w-full flex-row-bt-c opacity-80"
                }, [createTextVNode(" \u51CF\u5C11 "), createVNode("span", {
                  class: "text-[var(--el-color-error)]"
                }, " -" + toDisplayString(`\uFFE5${unref(currency)(unref(order).orderInfo.totalPrice).subtract(unref(order).orderInfo.spendPrice)}`), 1)])) : createCommentVNode("", true), createVNode(_component_ElDivider, {
                  style: {
                    "margin": "0.6rem 0"
                  },
                  "opacity-30": ""
                  ...
                  "w-full": "",
                  "flex-row-bt-c": ""
                }, [createTextVNode(" \u603B\u8BA1 "), createVNode("h3", {
                  class: "flex text-[var(--el-color-error)]"
                }, [createTextVNode(" \uFFE5 "), createVNode("strong", {
                  block: ""
                }, toDisplayString(unref(getReduce) ? unref(currency)(unref(order).orderInfo.spendPrice) : unref(getFinalPrice)), 1)])])]), createVNode("section", {
                  class: "sticky bottom-6 flex-row-bt-c shadow-lg border-default v-card"
                }, [createVNode("div", {
                  class: "menu"
                  ...
                  default: withCtx(() => [createVNode("i", {
                    ...
                    default: withCtx(() => [createTextVNode(" \u5BA2\u670D ")]),
                    _: 1
                  })]),
                  _: 1
                })]), createVNode("div", {
                  class: "group submit flex cursor-pointer items-center"
                }, [createVNode("i", {
                  class: "fold i-solar:menu-dots-bold-duotone mr-6 block h-6 w-6 md:hidden"
                }), createVNode("div", {
                  class: "submit-lbtns mr-3 hidden flex-row-c-c transition-200 transition-all md:flex border-default md:border-none"
                  ...
                  default: withCtx(() => [createTextVNode(" \u53D6\u6D88\u8BA2\u5355 ")]),
                  _: 1
                }, 8, ["onClick"])) : createCommentVNode("", true), unref(order).orderInfo.status === unref(OrdersStatus).REFUND_SUCCESS || unref(order).orderInfo.status === unref(OrdersStatus).CANCELED || unref(order).orderInfo.status === unref(OrdersStatus).DELAY_CANCELED || unref(order).orderInfo.status === unref(OrdersStatus).COMMENTED ? (openBlock(), createBlock(_component_el_button, {
                  key: 1,
                  type: "danger",
                  plain: "",
                  onClick: ($event) => deleteOrder(unref(order).orderId)
                }, {
                  default: withCtx(() => [createTextVNode(" \u5220\u9664\u8BA2\u5355 ")]),
                  _: 1
                }, 8, ["onClick"])) : createCommentVNode("", true), unref(order).status === unref(OrdersStatus).UN_PAID || unref(order).status === unref(OrdersStatus).PAID ? (openBlock(), createBlock(_component_el_button, {
                  key: 2,
                  size: "default",
                  ...
                  default: withCtx(() => [createTextVNode(toDisplayString(unref(isUpdate) ? "\u53D6\u6D88\u4FEE\u6539" : "\u4FEE\u6539\u8BA2\u5355"), 1)]),
                  _: 1
                }, 8, ["type", "onClick"])) : createCommentVNode("", true), unref(order).status === unref(OrdersStatus).PAID || unref(order).status === unref(OrdersStatus).RECEIVED || unref(order).status === unref(OrdersStatus).DELIVERED ? (openBlock(), createBlock(_component_el_button, {
                  key: 3,
                  size: "default",
                  type: "danger",
                  plain: "",
                  ...
                  default: withCtx(() => [createTextVNode(" \u7533\u8BF7\u9000\u6B3E ")]),
                  _: 1
                }, 8, ["onClick"])) : createCommentVNode("", true)]), unref(ordersTitle).submitText ? (openBlock(), createBlock(_component_el_button, {
                  key: 0,
                  size: "default",
                  "min-w-8em": "",
                  "shadow-md": "",
                  ...
                  default: withCtx(() => [createTextVNode(toDisplayString(unref(isUpdate) && unref(order).status !== unref(OrdersStatus).READY ? "\u786E \u8BA4" : unref(ordersTitle).submitText), 1)]),
                  _: 1
                }, 8, ["type", "onClick"])) : createCommentVNode("", true)])])])), [[_directive_loading, unref(isLoading), void 0, {
                  fullscreen: true,
                  lock: true
                  ...
                  default: withCtx(() => [createVNode("h4", {
                    mb4: "",
                    "font-500": ""
                  }, " \u8BA2\u5355\u5DF2\u5220\u9664\u6216\u4E0D\u5B58\u5728\uFF01 "), createVNode(_component_el_button, {
                    type: "primary",
                    onClick: toBack
                  }, {
...
const detail = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c39435a3"]]);

export { detail as default };
//# sourceMappingURL=detail-mhkoPQne.mjs.map
