...
import { u as useUserStore, aF as getUserLeave, E as ElMessage, d as __nuxt_component_2 } from '../server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "rounded-4px px-10 py-8 v-card"
      }, _attrs))}><div class="flex justify-between"><strong class="inline-block w-8rem flex-row-c-c cursor-pointer opacity-90 transition-300 hover:scale-110"><small mr-4 text-1em> \u79EF\u5206 </small><h2${ssrRenderAttrs(mergeProps({
        inline: ""
      }, ssrGetDirectiveProps(_ctx, _directive_incre_up_int, unref(points))))}></h2></strong><div ml-3em flex flex-col><small pb-3>\u7B49\u7EA7\uFF1Alv.${ssrInterpolate(unref(getLeave))}</small>`);
      ...
      _push(ssrRenderComponent(_component_el_popover, {
        ...
        reference: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode("small", {
              ...
              "text-blueGray": "",
              underline: ""
            }, [createTextVNode(" \u5982\u4F55\u83B7\u53D6\u79EF\u5206? "), createVNode("i", {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [createVNode("li", null, "1\u3001\u901A\u8FC7\u94B1\u5305\u989D\u5EA6\u5145\u503C"), createVNode("li", null, "2\u3001\u901A\u8FC7\u6BCF\u65E5\u7B7E\u5230")];
          }
        }),
        _: 1
      }, _parent));
...
//# sourceMappingURL=SigninCard-hNL7zee-.mjs.map
