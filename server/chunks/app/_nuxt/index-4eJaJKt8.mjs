...
import { o as BaseUrl, p as useHttp, B as BaseUrlImg, b as _export_sfc } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      })}" data-v-c6ecc9ec> \uFFE5${ssrInterpolate(unref(currency)(_ctx.goods.costPrice))}</small>`);
...
function getGoodsListByPage(page, size, dto) {
  return useHttp.post(`/goods/list/${page}/${size}`, {
    ...dto
  });
}
...
//# sourceMappingURL=index-4eJaJKt8.mjs.map
