...
import { o as BaseUrl, b as _export_sfc } from '../server.mjs';
import { _ as __nuxt_component_1 } from './nuxt-link-tpk2tUXY.mjs';
import { c as getGoodsListByPage, _ as __nuxt_component_1$1 } from './index-4eJaJKt8.mjs';
  ...
  async setup(__props, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.transiton ? TransitionGroup : "div"), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [(openBlock(true), createBlock(Fragment, null, renderList(unref(goodsList), (p) => {
      ...
      if (_ctx.showMoreText) {
        _push(`<small style="${ssrRenderStyle(unref(isNoMore) || unref(isNot) ? null : {
          display: "none"
        })}" mt-2 block w-full text-center text-bluegray tracking-1 data-v-a2462ea3>${ssrInterpolate(unref(isNoMore) ? "\u6682\u65E0\u66F4\u591A\u5546\u54C1" : "\u6682\u65E0\u5546\u54C1")}</small>`);
      } else {
        _push(`<!---->`);
      }
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a2462ea3"]]);

export { __nuxt_component_2 as _, getGoodsCategoryTree as a, getGoodsCategoryList as b, getGoodsCategoryByGid as g };
//# sourceMappingURL=GoodsListSsr-hXClBatk.mjs.map
