...
import { j as getPostTotal } from './post-uKGC7P8z.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    dto: {},
    gridClass: {
      default: "grid grid-cols-4 grid-gap-4"
    },
    cardClass: {
      default: ""
    }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: "flex flex-col gap-3 rounded-4px v-card"
      }, _attrs))}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            return [createVNode(_component_CardElImage, {
              ...
              fit: "cover"
            }, null, 8, ["src", "alt"]), createVNode("h4", {
              "text-center": ""
            }, toDisplayString((_f = _ctx.user) == null ? void 0 : _f.nickname), 1)];
          }
        }),
        _: 1
      }, _parent));
      ...
      ssrRenderList(unref(dataList), (p, i) => {
        _push(`<div class="${ssrRenderClass([_ctx.cardClass, "w-full p-2 text-center leading-1.8em transition-200 hover-scale-110"])}"><div class="title text-1em">${ssrInterpolate(p.label)}</div><span${ssrRenderAttrs(mergeProps({
          class: "text-1em"
        }, ssrGetDirectiveProps(_ctx, _directive_incre_up_int, p.value)))}></span></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
//# sourceMappingURL=UserPostTotal-wNX1zEUK.mjs.map
