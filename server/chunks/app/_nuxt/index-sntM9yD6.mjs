...
import { a5 as useHead, D as appName, c as useSeoMeta, i as isTrue, u as useUserStore, B as BaseUrlImg, S as StatusCode, d as appKeywords, _ as __nuxt_component_0, f as __nuxt_component_2$1, E as ElMessage, n as navigateTo, b as _export_sfc, h as ElButton } from '../server.mjs';
...
import { b as getEventsLists } from './index-hw581Gte.mjs';
...
import { b as getGoodsListByPageLazy } from './index-VI4pRKfC.mjs';
import { a as getGoodsCategoryTree, b as getGoodsCategoryList, _ as __nuxt_component_1 } from './GoodsListSsr-NiOzqUEG.mjs';
import { E as ElTabs, a as ElTabPane } from './tab-pane-G1YGUFAr.mjs';
import { _ as _sfc_main$a } from './PreLoading-Jnbo7kLW.mjs';
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative flex-row-bt-c flex-col md:flex-row" }, _attrs))}><div class="animate-[fade-in-down_0.3s_ease] select-none py-10">`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "h-3rem text-lg tracking-1 opacity-80" })
            ];
          }
        })
      }, _parent));
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<img${ssrRenderAttrs(mergeProps({
        src: _ctx.imgSrc ? ("BaseUrlImg" in _ctx ? _ctx.BaseUrlImg : unref(BaseUrlImg)) + _ctx.imgSrc : _ctx.src,
        fit: "cover",
        "object-cover": ""
      }, _ctx.$attrs, {
        alt: _ctx.alt || "\u3010\u56FE\u7247\u3011"
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/card/NuxtImg.vue");
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_card_nuxt_img = _sfc_main$8;
      _push(`<div${ssrRenderAttrs(mergeProps({
        "cursor-pointer": "",
        "overflow-hidden": "",
        "rounded-6px": "",
        class: "swpier relative"
      }, _attrs))} data-v-86f3083f>`);
      _push(ssrRenderComponent(_component_swiper, {
        ...
        modules: [
          ...
          "SwiperController" in _ctx ? _ctx.SwiperController : unref(Controller),
          "SwiperEffectCreative" in _ctx ? _ctx.SwiperEffectCreative : unref(EffectCreative),
          "SwiperMousewheel" in _ctx ? _ctx.SwiperMousewheel : unref(Mousewheel)
        ]
      }, {
            ...
            ssrRenderList(unref(eventList), (p) => {
              _push2(ssrRenderComponent(_component_swiper_slide, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_card_nuxt_img, {
                      format: "webp",
                      loading: "lazy",
                    ...
                    _push3(`<section class="tip w-full flex flex-col justify-around rounded-0 px-5 py-3 text-xs leading-1.4em line-height-none tracking-0.2em card-default md:text-1em md:line-height-normal" data-v-86f3083f${_scopeId2}><h3 class="title" data-v-86f3083f${_scopeId2}>${ssrInterpolate(p.title)}</h3>`);
                    if (p.status === 0) {
                      _push3(`<p opacity-80 style="${ssrRenderStyle({ "color": "var(--el-color-success)" })}" data-v-86f3083f${_scopeId2}> \u6D3B\u52A8\u5373\u5C06\u5F00\u59CB </p>`);
                    } else if (p.status === 1) {
                      _push3(`<p opacity-80 data-v-86f3083f${_scopeId2}> \u8DDD\u79BB\u7ED3\u675F\u8FD8\u6709\uFF1A <strong text-lg style="${ssrRenderStyle({ "color": "var(--el-color-error)" })}" data-v-86f3083f${_scopeId2}>${ssrInterpolate(unref(getEndDay)(p.startTime, p.endTime))}</strong> \u5929 </p>`);
                    } else if (p.status === 2) {
                      _push3(`<p opacity-80 style="${ssrRenderStyle({ "text-decoration": "line-through" })}" data-v-86f3083f${_scopeId2}> \u6D3B\u52A8\u5DF2\u7ECF\u7ED3\u675F </p>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</section>`);
                    ...
                    return [
                      createVNode(_component_card_nuxt_img, {
                        format: "webp",
                        loading: "lazy",
                        src: ("BaseUrlImg" in _ctx ? _ctx.BaseUrlImg : unref(BaseUrlImg)) + p.images,
                        alt: p.details,
                      ...
                      createVNode("section", { class: "tip w-full flex flex-col justify-around rounded-0 px-5 py-3 text-xs leading-1.4em line-height-none tracking-0.2em card-default md:text-1em md:line-height-normal" }, [
                        createVNode("h3", { class: "title" }, toDisplayString(p.title), 1),
                        p.status === 0 ? (openBlock(), createBlock("p", {
                          key: 0,
                          "opacity-80": "",
                          ...
                          createTextVNode(" \u5929 ")
                        ])) : p.status === 2 ? (openBlock(), createBlock("p", {
                          key: 2,
                          "opacity-80": "",
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-86f3083f"]]);
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-row-bt-c cursor-pointer p-1" }, _attrs))}><div h-6em w-6em overflow-hidden border-default card-default>`);
      _push(ssrRenderComponent(_component_card_nuxt_img, {
        format: "webp",
        loading: "lazy",
        class: "object-cover transition-300 hover:transform-scale-110",
        src: ("BaseUrlImg" in _ctx ? _ctx.BaseUrlImg : unref(BaseUrlImg)) + _ctx.goods.images[0],
        style: { "width": "6em", "height": "6em" },
        quality: "40",
        alt: `${_ctx.goods.name}\u5546\u54C1\u56FE\u7247`,
        fit: "cover"
      }, null, _parent));
      _push(`</div><div class="flex flex-1 flex-col justify-between px-2 md:px-4"><h3 class="max-w-12em truncate tracking-1px md:max-w-16em">${ssrInterpolate(_ctx.goods.name)}</h3><p mb-5 mt-1 color-red-6 font-700 leading-1.2em> \uFFE5${ssrInterpolate(unref(currency)(_ctx.goods.price))} <small text-0.8em color-coolgray style="${ssrRenderStyle({ "text-decoration": "line-through" })}"> \uFFE5${ssrInterpolate(unref(currency)(_ctx.goods.costPrice))}</small></p><div flex-row-bt-c flex-1 class="group"><small mr-3 opacity-80> \u6D4F\u89C8\uFF1A${ssrInterpolate(_ctx.goods.views)}</small><small opacity-80>\u9500\u91CF\uFF1A${ssrInterpolate(_ctx.goods.sales)}</small>`);
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "hot-list h-420px min-h-420px flex flex-col overflow-visible rounded-4px p-4 shadow-sm backdrop-blur-20px md:w-470px border-default v-card dark:bg-dark-5" }, _attrs))} data-v-78351b3b><h3 px-1 data-v-78351b3b> \u70ED\u95E8\u5546\u54C1 <span i-solar:fire-bold mx-2 bg-red-6 p-3 data-v-78351b3b></span></h3>`);
      _push(ssrRenderComponent(_component_el_scrollbar, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${ssrRenderAttrs(ssrGetDirectiveProps(_ctx, _directive_auto_animate))} data-v-78351b3b${_scopeId}><!--[-->`);
            ...
            _push2(ssrRenderComponent(_component_el_text, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createTextVNode(toDisplayString(unref(noMore) ? "\u6682\u65E0\u66F4\u591A" : "\u67E5\u770B\u66F4\u591A"), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              withDirectives((openBlock(), createBlock("div", null, [
                (openBlock(true), createBlock(Fragment, null, renderList(unref(hotGoodsList), (p) => {
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-78351b3b"]]);
            ...
            _push2(ssrRenderComponent(_component_el_button, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createVNode("div", { class: "absolute left-0 top-0 z-0 h-full w-full overflow-hidden rounded-4px opacity-85" }, [
                      createVNode("img", {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data } = ([__temp, __restore] = withAsyncContext(() => getGoodsCategoryTree()), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_scrollbar = ElScrollbar;
      const _component_IndexGoodsCategoryCard = _sfc_main$4;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "category-list" }, _attrs))}><h3 class="title" pl-1 dark:text-amber-4> \u70ED\u95E8\u5206\u7C7B <i i-solar:adhesive-plaster-bold-duotone ml-4 bg-yellow-4 p-3></i></h3>`);
      _push(ssrRenderComponent(_component_el_scrollbar, {
        style: { "width": "100%" },
        noresize: "",
        "z-0": "",
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const planList = [
      { value: "isHot", icon: "i-solar:fire-bold-duotone bg-[var(--el-color-danger)]", label: "\u70ED\u5356\u597D\u7269", dto: { saleSort: isTrue.TRUE } },
      { value: "isNew", icon: "i-solar:star-fall-minimalistic-bold-duotone bg-[var(--el-color-warning)]", label: "\u65B0\u54C1\u4E0A\u67B6", dto: { isNew: isTrue.TRUE } },
      { value: "isViews", icon: "i-solar:sale-bold-duotone bg-[var(--el-color-success)]", label: "\u70ED\u5356\u597D\u7269", dto: { viewsSort: isTrue.TRUE } }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_el_tabs = ElTabs;
      const _component_el_tab_pane = ElTabPane;
      const _component_ListGoodsListSsr = __nuxt_component_1;
      _push(ssrRenderComponent(_component_el_tabs, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                label: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      ...
                      createVNode("strong", null, toDisplayString(p.label), 1)
                    ];
                  }
                }),
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            return [
              (openBlock(), createBlock(Fragment, null, renderList(planList, (p) => {
      ...
      ssrRenderList(unref(categoryList), (p, i) => {
        ...
        if (unref(goodsRefs) && unref(goodsRefs)[i] && ((_b = (_a = unref(goodsRefs)[i]) == null ? void 0 : _a.goodsList) == null ? void 0 : _b.length)) {
          ...
          _push(ssrRenderComponent(_component_card_nuxt_img, {
            ...
            alt: `${p.name}\u5206\u7C7B`,
            class: "ml-4 h-8 w-8 rounded-1/2 object-cover"
          }, null, _parent));
          _push(`<span ml-a cursor-pointer text-0.8rem opacity-60>\u66F4\u591A</span></h3>`);
        } else {
          _push(`<!---->`);
        }
        _push(ssrRenderComponent(_component_ListGoodsListSsr, {
          ref_for: true,
          ref_key: "goodsRefs",
          ref: goodsRefs,
          class: "grid grid-cols-2 grid-gap-6 md:grid-cols-5",
          ...
          load: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                createVNode("div", { class: "h-2rem w-full" })
              ];
            }
          }),
          _: 2
...
const __nuxt_component_10_lazy = defineAsyncComponent(() => import('./GoodsList-jFkO4WGn.mjs').then((m) => m.default || m));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IndexTopMenu = _sfc_main$9;
      ...
      const _component_ClientOnly = __nuxt_component_2$1;
      const _component_OtherPreLoading = _sfc_main$a;
      const _component_el_text = ElText;
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, { name: "main" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="py-0 layout-default"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_IndexTopMenu, { "w-full": "" }, null, _parent2, _scopeId));
            _push2(`<div w-full flex flex-col transition-300 md:flex-row${_scopeId}>`);
            if (_ctx.$route.path === "/") {
              _push2(ssrRenderComponent(_component_IndexSwiperList, { class: "my-6 aspect-ratio-1.48 w-full flex-shrink-0 md:mr-a md:h-420px md:w-620px" }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            ...
            _push2(ssrRenderComponent(_component_IndexCategoryGoodsList, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createVNode("div", { class: "grid grid-cols-2 grid-gap-6 md:grid-cols-5" }, [
            ...
            return [
              createVNode("div", { class: "py-0 layout-default" }, [
                createVNode(_component_IndexTopMenu, { "w-full": "" }),
                createVNode("div", {
                  "w-full": "",
                  flex: "",
                  "flex-col": "",
                  ...
                  createVNode(_component_ClientOnly, null, {
                    ...
                    default: withCtx(() => [
                      createVNode("div", { class: "w-full" }, [
                        !unref(isShowGoods) ? (openBlock(), createBlock(_component_el_text, {
                          key: 0,
...
//# sourceMappingURL=index-sntM9yD6.mjs.map
