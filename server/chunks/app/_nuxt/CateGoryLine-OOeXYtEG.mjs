...
import { u as useUserStore, g8 as getCommPostCategoryById, S as StatusCode, B as BaseUrlImg } from '../server.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("div", { class: "ml-4 h-full flex flex-col justify-around truncate tracking-0.16em" }, [
                createVNode("h3", null, toDisplayString((_d = unref(category)) == null ? void 0 : _d.name), 1),
                createVNode("span", { class: "text-0.7rem opacity-50 hover:text-[var(--el-color-info)] hover:transition-200" }, " \u67E5\u770B\u76F8\u5173 ")
              ])
            ];
          }
        }),
...
//# sourceMappingURL=CateGoryLine-OOeXYtEG.mjs.map
